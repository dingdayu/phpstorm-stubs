 ...
 * @link http://php.net/manual/zh/function.mssql-connect.php
 ...
 * @link http://php.net/manual/zh/function.mssql-pconnect.php
 * @param string $servername [optional] <p>
 * The MS SQL server. It can also include a port number. e.g. 
 * hostname:port.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mssql-close.php
 ...
 * @link http://php.net/manual/zh/function.mssql-select-db.php
 ...
 * (PHP 4, PHP 5, PECL odbtp &gt;= 1.1.1)<br/>
 * Send MS SQL query
 * @link http://php.net/manual/zh/function.mssql-query.php
 ...
 * @link http://php.net/manual/zh/function.mssql-fetch-batch.php
 ...
 * @link http://php.net/manual/zh/function.mssql-rows-affected.php
 ...
 * (PHP 4, PHP 5, PECL odbtp &gt;= 1.1.1)<br/>
 * Free result memory
 * @link http://php.net/manual/zh/function.mssql-free-result.php
 * @param resource $result <p>
 ...
 * @link http://php.net/manual/zh/function.mssql-get-last-message.php
 ...
 * @link http://php.net/manual/zh/function.mssql-num-rows.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mssql-num-fields.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mssql-fetch-field.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mssql-fetch-row.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mssql-fetch-array.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mssql-fetch-assoc.php
 ...
 * (PHP 4, PHP 5, PECL odbtp &gt;= 1.1.1)<br/>
 * Fetch row as object
 * @link http://php.net/manual/zh/function.mssql-fetch-object.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mssql-field-length.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mssql-field-name.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mssql-field-type.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mssql-data-seek.php
 ...
 * @link http://php.net/manual/zh/function.mssql-field-seek.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * (PHP 4, PHP 5, PECL odbtp &gt;= 1.1.1)<br/>
 * Get result data
 * @link http://php.net/manual/zh/function.mssql-result.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mssql-next-result.php
 * @param resource $result_id <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mssql-min-error-severity.php
 ...
 * @link http://php.net/manual/zh/function.mssql-min-message-severity.php
 * @param int $severity <p>
 ...
 * @link http://php.net/manual/zh/function.mssql-init.php
 ...
 * @link http://php.net/manual/zh/function.mssql-bind.php
 ...
 * @link http://php.net/manual/zh/function.mssql-execute.php
 * @param resource $stmt <p>
 ...
 * @link http://php.net/manual/zh/function.mssql-free-statement.php
 * @param resource $stmt <p>
 * Statement resource, obtained with mssql_init.
 * </p>
 * @return bool true on success or false on failure.
 ...
 * @link http://php.net/manual/zh/function.mssql-guid-string.php
 ...
 * @link http://php.net/manual/zh/mssql.constants.php
 */
