 ...
 * @link http://php.net/manual/zh/function.ereg.php
 ...
 * @link http://php.net/manual/zh/function.ereg-replace.php
 ...
 * @link http://php.net/manual/zh/function.eregi.php
 * @deprecated 5.3.0 Use preg_match() instead
 * @param string $pattern <p>
 ...
 * @link http://php.net/manual/zh/function.eregi-replace.php
 * @deprecated 5.3.0 Use preg_replace() instead
 * @param string $pattern <p>
 * A POSIX extended regular expression.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.split.php
 ...
 * @link http://php.net/manual/zh/function.spliti.php
 ...
 * @link http://php.net/manual/zh/function.sql-regcase.php
 * @deprecated 5.3.0
 * @param string $string <p>
 * The input string.
 * </p>
