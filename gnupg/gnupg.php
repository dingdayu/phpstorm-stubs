<?php
/** GNUPG Constants
 * @link http://php.net/manual/zh/gnupg.constants.php
 */
 ...
 * @link http://php.net/manual/zh/book.gnupg.php
 * Class gnupg
 */
...
class gnupg {
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-adddecryptkey.php
	 * @phpstub
	 *
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-verify.php
	 * @phpstub
	 *
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-addencryptkey.php
	 * @phpstub
	 *
	 * @param string $fingerprint
	 *
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-addsignkey.php
	 * @phpstub
	 *
	 * @param string $fingerprint
	 * @param string $passphrase
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-cleardecryptkeys.php
	 * @phpstub
	 *
	 * @return bool
	 */
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-clearencryptkeys.php
	 * @phpstub
	 *
	 *
	 * @return bool
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-clearsignkeys.php
	 * @phpstub
	 *
	 *
	 * @return bool
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-decrypt.php
	 * @phpstub
	 *
	 * @param string $text
	 *
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-decryptverify.php
	 * @phpstub
	 *
	 * @param string $text
	 * @param string $plaintext
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-encrypt.php
	 * @phpstub
	 *
	 * @param string $plaintext
	 *
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-encryptsign.php
	 * @phpstub
	 *
	 * @param string $plaintext
	 *
	...
	/**
	 * Exports a key
	 * @link http://php.net/manual/zh/function.gnupg-export.php
	 * @phpstub
	 *
	 * @param string $fingerprint
	 *
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-geterror.php
	 * @phpstub
	 *
	 *
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-getprotocol.php
	 * @phpstub
	 *
	 *
	...
	/**
	 * Imports a key
	 * @link http://php.net/manual/zh/function.gnupg-import.php
	 * @phpstub
	 *
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-init.php
	 * @phpstub
	 *
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-keyinfo.php
	 * @phpstub
	 *
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-setarmor.php
	 * @phpstub
	 *
	 * @param int $armor
	 *
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-seterrormode.php
	 * @phpstub
	 *
	 * @param int $errormode
	 *
	 ...
	 * @link http://php.net/manual/zh/function.gnupg-setsignmode.php
	 * @phpstub
	 *
	 * @param int $signmode
	 *
	...
	/**
	 * Signs a given text
	 * @link http://php.net/manual/zh/function.gnupg-sign.php
	 * @phpstub
	 *
	 * @param string $plaintext
	 *
