...
/**
 * Reads a line
 * @link http://php.net/manual/zh/function.readline.php
 ...
 * @link http://php.net/manual/zh/function.readline-info.php
 ...
 * @link http://php.net/manual/zh/function.readline-add-history.php
 * @param string $line <p>
...
/**
 * Clears the history
 * @link http://php.net/manual/zh/function.readline-clear-history.php
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 * @since 4.0
 * @since 5.0
 */
...
/**
 * Lists the history
 * @link http://php.net/manual/zh/function.readline-list-history.php
...
/**
 * Reads the history
 * @link http://php.net/manual/zh/function.readline-read-history.php
...
/**
 * Writes the history
 * @link http://php.net/manual/zh/function.readline-write-history.php
 * @param string $filename [optional] <p>
 ...
 * @link http://php.net/manual/zh/function.readline-completion-function.php
 ...
 * @link http://php.net/manual/zh/function.readline-callback-handler-install.php
 ...
 * @link http://php.net/manual/zh/function.readline-callback-read-char.php
 ...
 * @link http://php.net/manual/zh/function.readline-callback-handler-remove.php
...
/**
 * Redraws the display
 * @link http://php.net/manual/zh/function.readline-redisplay.php
 * @return void No value is returned.
 * @since 5.1.0
 */
 ...
 * @link http://php.net/manual/zh/function.readline-on-new-line.php
 * @return void No value is returned.
 * @since 5.1.0
 */
