 ...
 * @link http://php.net/manual/zh/function.odbc-autocommit.php
 ...
 * @link http://php.net/manual/zh/function.odbc-binmode.php
 ...
 * @link http://php.net/manual/zh/function.odbc-close.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link http://php.net/manual/zh/function.odbc-close-all.php
 * @return void No value is returned.
 * @since 4.0
 * @since 5.0
 */
 ...
 * @link http://php.net/manual/zh/function.odbc-columns.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link http://php.net/manual/zh/function.odbc-commit.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 * @since 4.0
 ...
 * @link http://php.net/manual/zh/function.odbc-connect.php
 * @param string $dsn <p>
...
/**
 * Get cursorname
 * @link http://php.net/manual/zh/function.odbc-cursor.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.odbc-data-source.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link http://php.net/manual/zh/function.odbc-execute.php
 * @param resource $result_id <p>
 ...
 * @link http://php.net/manual/zh/function.odbc-error.php
 ...
 * @link http://php.net/manual/zh/function.odbc-errormsg.php
 * @param resource $connection_id [optional] The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @return string If <i>connection_id</i> is specified, the last state
 * of that connection is returned, else the last state of any connection
 ...
 * @link http://php.net/manual/zh/function.odbc-exec.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link http://php.net/manual/zh/function.odbc-fetch-array.php
 ...
 * @link http://php.net/manual/zh/function.odbc-fetch-object.php
 * @param resource $result <p>
 * The result resource from <b>odbc_exec</b>.
 * </p>
 * @param int $rownumber [optional] <p>
...
/**
 * Fetch a row
 * @link http://php.net/manual/zh/function.odbc-fetch-row.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.odbc-fetch-into.php
 * @param resource $result_id <p>
 * The result resource.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.odbc-field-len.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.odbc-field-scale.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 * @param int $field_number <p>
...
/**
 * Get the columnname
 * @link http://php.net/manual/zh/function.odbc-field-name.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 * @param int $field_number <p>
...
/**
 * Datatype of a field
 * @link http://php.net/manual/zh/function.odbc-field-type.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 * @param int $field_number <p>
 ...
 * @link http://php.net/manual/zh/function.odbc-field-num.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.odbc-free-result.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.odbc-gettypeinfo.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link http://php.net/manual/zh/function.odbc-longreadlen.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 * @param int $length <p>
 ...
 * @link http://php.net/manual/zh/function.odbc-next-result.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.odbc-num-fields.php
 * @param resource $result_id <p>
 ...
 * @link http://php.net/manual/zh/function.odbc-num-rows.php
 * @param resource $result_id <p>
 * The result identifier returned by <b>odbc_exec</b>.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.odbc-pconnect.php
 * @param string $dsn
 * @param string $user
 ...
 * @link http://php.net/manual/zh/function.odbc-prepare.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @param string $query_string <p>
...
/**
 * Get result data
 * @link http://php.net/manual/zh/function.odbc-result.php
 * @param resource $result_id <p>
 * The ODBC resource.
 * </p>
 * @param mixed $field <p>
 ...
 * @link http://php.net/manual/zh/function.odbc-result-all.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.odbc-rollback.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 * @since 4.0
 ...
 * @link http://php.net/manual/zh/function.odbc-setoption.php
 * @param resource $id <p>
 ...
 * @link http://php.net/manual/zh/function.odbc-specialcolumns.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link http://php.net/manual/zh/function.odbc-statistics.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @param string $qualifier <p>
 * The qualifier.
 ...
 * @link http://php.net/manual/zh/function.odbc-tables.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @param string $qualifier [optional] <p>
 * The qualifier.
 ...
 * @link http://php.net/manual/zh/function.odbc-primarykeys.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link http://php.net/manual/zh/function.odbc-columnprivileges.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @param string $qualifier <p>
 * The qualifier.
 ...
 * @link http://php.net/manual/zh/function.odbc-tableprivileges.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @param string $qualifier <p>
 * The qualifier.
 ...
 * @link http://php.net/manual/zh/function.odbc-foreignkeys.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link http://php.net/manual/zh/function.odbc-procedures.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link http://php.net/manual/zh/function.odbc-procedurecolumns.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link http://php.net/manual/zh/function.odbc-do.php
 * @param $connection_id
 * @param $query
 ...
 * @link http://php.net/manual/zh/function.odbc-field-precision.php
 * @param $result_id
 * @param $field_number
 * @since 4.0
 * @since 5.0
