...
class DateTimeImmutable implements DateTimeInterface {
     ...
     * (PHP 5 &gt;=5.5.0)<br/>
     * Sets the ISO date
     * @link http://php.net/manual/zh/class.datetimeimmutable.php
     * @param int $year <p>Year of the date.</p>
 ...
 * @link http://php.net/manual/zh/class.datetime.php
 */
class DateTime implements DateTimeInterface {
     ...
     * @return DateTime
     * @link http://php.net/manual/zh/datetime.construct.php
     */
    public function __construct ($time='now', DateTimeZone $timezone=null) {}

    /**
     * @return void
     * @link http://php.net/manual/zh/datetime.wakeup.php
     */
    public function __wakeup () {}
     ...
     * @param string $format
     * @return string
     * @link http://php.net/manual/zh/datetime.format.php
     */
    public function format ($format) {}
     ...
     * @link http://php.net/manual/zh/datetime.modify.php
     */
    public function modify ($modify) {}
     ...
     * @param DateInterval $interval
     * @return static
     * @link http://php.net/manual/zh/datetime.add.php
     */
    public function add (DateInterval $interval) {}
     ...
     * @param DateInterval $interval
     * @return static
     * @link http://php.net/manual/zh/datetime.sub.php
     */
    public function sub (DateInterval $interval) {}
     ...
     * @return DateTimeZone
     * @link http://php.net/manual/zh/datetime.gettimezone.php
     */
    public function getTimezone () {}
     ...
     * @param DateTimeZone $timezone
     * @return static
     * @link http://php.net/manual/zh/datetime.settimezone.php
     */
     ...
     * Returns the timezone offset
     * @return int
     * @link http://php.net/manual/zh/datetime.getoffset.php
     */
    public function getOffset () {}
     ...
     * @return static|false
     * @since 7.1.0 $microseconds parameter added.
     * @link http://php.net/manual/zh/datetime.settime.php
     */
    public function setTime ($hour, $minute, $second=0, $microseconds=0) {}
     ...
     * @param int $day
     * @return static
     * @link http://php.net/manual/zh/datetime.setdate.php
     */
    public function setDate ($year, $month, $day) {}
     ...
     * @param int $day
     * @return static
     * @link http://php.net/manual/zh/datetime.setisodate.php
     */
    public function setISODate ($year, $week, $day=1) {}
     ...
     * @return static
     * @link http://php.net/manual/zh/datetime.settimestamp.php
     */
    public function setTimestamp ($unixtimestamp) {}
     ...
     * Gets the Unix timestamp.
     * @return int
     * @link http://php.net/manual/zh/datetime.gettimestamp.php
     */
    public function getTimestamp () {}
     ...
     * @link http://php.net/manual/zh/datetime.diff.php
     */
    public function diff ($datetime2, $absolute = false) {}
     ...
     * @link http://php.net/manual/zh/datetime.createfromformat.php
     */
     ...
     * @return array
     * @link http://php.net/manual/zh/datetime.getlasterrors.php
     */
    public static function getLastErrors () {}

    /**
     * The __set_state handler
     * @link http://php.net/manual/zh/datetime.set-state.php
     * @param array $array <p>Initialization array.</p>
 ...
 * @link http://php.net/manual/zh/class.datetimezone.php
 */
class DateTimeZone {
    const AFRICA = 1;
    const AMERICA = 2;
     ...
     * @link http://php.net/manual/zh/datetimezone.construct.php
     */
     ...
     * @return string
     * @link http://php.net/manual/zh/datetimezone.getname.php
     */
     ...
     * @return array
     * @link http://php.net/manual/zh/datetimezone.getlocation.php
     */
     ...
     * @return int
     * @link http://php.net/manual/zh/datetimezone.getoffset.php
     */
     ...
     * @return array
     * @link http://php.net/manual/zh/datetimezone.gettransitions.php
     */
     ...
     * @return array
     * @link http://php.net/manual/zh/datetimezone.listabbreviations.php
     */
     ...
     * @return array
     * @link http://php.net/manual/zh/datetimezone.listidentifiers.php
     */
 ...
 * @link http://php.net/manual/zh/class.dateinterval.php
 */
class DateInterval {
    /**
     * Number of years
     ...
     * @link http://php.net/manual/zh/dateinterval.construct.php
     ...
     * @param $format
     * @return string
     * @link http://php.net/manual/zh/dateinterval.format.php
     */
    public function format ($format) {}
     ...
     * @param string $time
     * @return DateInterval
     * @link http://php.net/manual/zh/dateinterval.createfromdatestring.php
     */
 ...
 * @link http://php.net/manual/zh/class.dateperiod.php
 * @since 5.3.0
 */
class DatePeriod implements Traversable {
     ...
     * @link http://php.net/manual/zh/dateperiod.construct.php
     * @since 5.3.0
     */
     ...
     * Gets the interval
     * @return DateInterval
     * @link http://php.net/manual/zh/dateperiod.getdateinterval.php
     * @since 5.6.5
     */
     ...
     * @link http://php.net/manual/zh/dateperiod.getenddate.php
     * @since 5.6.5
     */
     ...
     * Gets the start date
     * @return DateTimeInterface
     * @link http://php.net/manual/zh/dateperiod.getstartdate.php
     * @since 5.6.5
     */
