...
class ZipArchive  {
	 ...
	 * @link http://php.net/manual/zh/zip.constants.php
	 */
	const CREATE = 1;
	 ...
	 * @link http://php.net/manual/zh/ziparchive.open.php
	 ...
	 * @link http://php.net/manual/zh/ziparchive.close.php
	 ...
	 * @link http://php.net/manual/zh/ziparchive.getstatusstring.php
	 ...
	 * Add a new directory
	 * @link http://php.net/manual/zh/ziparchive.addemptydir.php
	 ...
	 * @link http://php.net/manual/zh/ziparchive.addfromstring.php
	 ...
	 * @link http://php.net/manual/zh/ziparchive.addfile.php
	 * @param string $filename <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.addglob.php
	 ...
	 * @link http://php.net/manual/zh/ziparchive.addpattern.php
	 * @param string $pattern <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.renameindex.php
	 * @param int $index <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.renamename.php
	 * @param string $name <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.setarchivecomment.php
	 ...
	 * @link http://php.net/manual/zh/ziparchive.getarchivecomment.php
	 * @param int $flags [optional] <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.setcommentindex.php
	 * @param int $index <p>
	 * Index of the entry.
	 * </p>
	 * @param string $comment <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.setcommentname.php
	 * @param string $name <p>
	 * Name of the entry.
	 * </p>
	 * @param string $comment <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.setcompressionindex.php
	 ...
	 * http://php.net/manual/zh/ziparchive.setcompressionname.php
	 ...
	 * @link http://php.net/manual/zh/ziparchive.getcommentindex.php
	 * @param int $index <p>
	 * Index of the entry
	 * </p>
	 * @param int $flags [optional] <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.getcommentname.php
	 * @param string $name <p>
	 * Name of the entry
	 * </p>
	 * @param int $flags [optional] <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.deleteindex.php
	 * @param int $index <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.deletename.php
	 * @param string $name <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.statname.php
	 * @param string $name <p>
	 * Name of the entry
	 * </p>
	 * @param int $flags [optional] <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.statindex.php
	 * @param int $index <p>
	 * Index of the entry
	 * </p>
	 * @param int $flags [optional] <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.locatename.php
	 * @param string $name <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.getnameindex.php
	 * @param int $index <p>
	 * Index of the entry.
	 * </p>
	 * @param int $flags [optional] <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.unchangearchive.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 */
	 ...
	 * @link http://php.net/manual/zh/ziparchive.unchangeall.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 */
	 ...
	 * @link http://php.net/manual/zh/ziparchive.unchangeindex.php
	 * @param int $index <p>
	 * Index of the entry.
	 * </p>
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 ...
	 * @link http://php.net/manual/zh/ziparchive.unchangename.php
	 * @param string $name <p>
	 * Name of the entry.
	 * </p>
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 ...
	 * @link http://php.net/manual/zh/ziparchive.extractto.php
	 ...
	 * @link http://php.net/manual/zh/ziparchive.getfromname.php
	 * @param string $name <p>
	 * Name of the entry
	 * </p>
	 * @param int $length [optional] <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.getfromindex.php
	 * @param int $index <p>
	 * Index of the entry
	 * </p>
	 * @param int $length [optional] <p>
	 ...
	 * @link http://php.net/manual/zh/ziparchive.getstream.php
	 * @param string $name <p>
 ...
 * Open a ZIP file archive
 * @link http://php.net/manual/zh/function.zip-open.php
 * @param string $filename <p>
 * The file name of the ZIP archive to open.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.zip-close.php
 ...
 * @link http://php.net/manual/zh/function.zip-read.php
 * @param resource $zip <p>
 * A ZIP file previously opened with <b>zip_open</b>.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.zip-entry-open.php
 * @param resource $zip <p>
 ...
 * @link http://php.net/manual/zh/function.zip-entry-close.php
 * @param resource $zip_entry <p>
 ...
 * @link http://php.net/manual/zh/function.zip-entry-read.php
 * @param resource $zip_entry <p>
 * A directory entry returned by <b>zip_read</b>.
 * </p>
 * @param int $length [optional] <p>
 ...
 * @link http://php.net/manual/zh/function.zip-entry-filesize.php
 * @param resource $zip_entry <p>
 * A directory entry returned by <b>zip_read</b>.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.zip-entry-name.php
 * @param resource $zip_entry <p>
 * A directory entry returned by <b>zip_read</b>.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.zip-entry-compressedsize.php
 * @param resource $zip_entry <p>
 * A directory entry returned by <b>zip_read</b>.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.zip-entry-compressionmethod.php
 * @param resource $zip_entry <p>
 * A directory entry returned by <b>zip_read</b>.
 * </p>
