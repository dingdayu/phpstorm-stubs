 ...
 *
 * @link http://php.net/manual/zh/function.inotify-add-watch.php
 *
 * @param resource $inotify_instance <p>resource returned by {@link http://php.net/manual/zh/function.inotify-init.php inotify_init()}</p>
 * @param string   $pathname         <p>File or directory to watch</p>
 * @param int      $mask             <p>Events to watch for. See {@link http://php.net/manual/zh/inotify.constants.php Predefined Constants}.</p>
 *
 ...
 *
 * @link http://php.net/manual/zh/function.inotify-init.php
 ...
 *
 * @link http://php.net/manual/zh/function.inotify-queue-len.php
 *
 * @param resource $inotify_instance <p>resource returned by {@link http://php.net/manual/zh/function.inotify-init.php inotify_init()}</p>
 *
 ...
 *
 * @link http://php.net/manual/zh/function.inotify-read.php
 *
 * @param resource $inotify_instance <p>resource returned by {@link http://php.net/manual/zh/function.inotify-init.php inotify_init()}</p>
 *
 ...
 *
 * @link     http://php.net/manual/zh/function.inotify-rm-watch.php
 *
 * @param resource $inotify_instance <p>resource returned by {@link http://php.net/manual/zh/function.inotify-init.php inotify_init()}</p>
...
/**
 * @type int
 * @link http://php.net/manual/zh/inotify.constants.php
 */
const IN_ACCESS = 1;
/**
 * @type int
