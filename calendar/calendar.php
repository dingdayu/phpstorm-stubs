 ...
 * @link http://php.net/manual/zh/function.jdtogregorian.php
 ...
 * @link http://php.net/manual/zh/function.gregoriantojd.php
 * @param int $month <p>
 ...
 * @link http://php.net/manual/zh/function.jdtojulian.php
 * @param int $julianday <p>
 * A julian day number as integer
 * </p>
 ...
 * @link http://php.net/manual/zh/function.juliantojd.php
 * @param int $month <p>
 * The month as a number from 1 (for January) to 12 (for December)
 * </p>
 * @param int $day <p>
 ...
 * @link http://php.net/manual/zh/function.jdtojewish.php
 ...
 * @link http://php.net/manual/zh/function.jewishtojd.php
 * @param int $month <p>
 ...
 * @link http://php.net/manual/zh/function.jdtofrench.php
 * @param int $juliandaycount
 ...
 * @link http://php.net/manual/zh/function.frenchtojd.php
 * @param int $month <p>
 ...
 * @link http://php.net/manual/zh/function.jddayofweek.php
 * @param int $julianday <p>
 * A julian day number as integer
 * </p>
 ...
 * @link http://php.net/manual/zh/function.jdmonthname.php
 * @param int $julianday
 * @param int $mode
 ...
 * @link http://php.net/manual/zh/function.easter-date.php
 ...
 * @link http://php.net/manual/zh/function.easter-days.php
 * @param int $year [optional] <p>
 ...
 * @link http://php.net/manual/zh/function.unixtojd.php
 ...
 * @link http://php.net/manual/zh/function.jdtounix.php
 * @param int $jday <p>
 ...
 * @link http://php.net/manual/zh/function.cal-to-jd.php
 ...
 * @link http://php.net/manual/zh/function.cal-from-jd.php
 * @param int $jd <p>
 ...
 * @link http://php.net/manual/zh/function.cal-days-in-month.php
 * @param int $calendar <p>
 ...
 * @link http://php.net/manual/zh/function.cal-info.php
