...
/**
 * @link http://php.net/manual/zh/apc.constants.php
 */
 ...
 * @link http://php.net/manual/zh/function.apc-cache-info.php
 ...
 * @link http://php.net/manual/zh/function.apc-clear-cache.php
 ...
 * @link http://php.net/manual/zh/function.apc-sma-info.php
 ...
 * @link http://php.net/manual/zh/function.apc-store.php
 ...
 * @link http://php.net/manual/zh/function.apc-fetch.php
 ...
 * @link http://php.net/manual/zh/function.apc-delete.php
 ...
 *
 * @link http://php.net/manual/zh/function.apc-define-constants.php
 ...
 * @link http://php.net/manual/zh/function.apc-add.php
 ...
 * @link http://php.net/manual/zh/function.apc-compile-file.php
 ...
 * @link http://php.net/manual/zh/function.apc-load-constants.php
 ...
 * @link http://php.net/manual/zh/function.apc-exists.php
 ...
 *
 * @link http://php.net/manual/zh/function.apc-delete-file.php
 ...
 * @link http://php.net/manual/zh/function.apc-inc.php
 ...
 * @link http://php.net/manual/zh/function.apc-dec.php
...
/**
 * @link http://php.net/manual/zh/function.apc-cas.php
 * @param string $key
 * @param int $old
 * @param int $new
 * @return bool
 ...
 *
 * @link http://php.net/manual/zh/function.apc-bin-dump.php
 ...
 * @link http://php.net/manual/zh/function.apc-bin-dumpfile.php
 ...
 * @link http://php.net/manual/zh/function.apc-bin-load.php
 ...
 * @link http://php.net/manual/zh/function.apc-bin-loadfile.php
 ...
 *
 * @link http://php.net/manual/zh/class.apciterator.php
 */
class APCIterator implements Iterator
{
	/**
	 * Constructs an APCIterator iterator object
	 * @link http://php.net/manual/zh/apciterator.construct.php
	 ...
	 * @link http://php.net/manual/zh/apciterator.rewind.php
	 */
	public function rewind(){}

	/**
	 * Checks if the current iterator position is valid
	 * @link http://php.net/manual/zh/apciterator.valid.php
	 ...
	 * @link http://php.net/manual/zh/apciterator.current.php
	 ...
	 * @link http://php.net/manual/zh/apciterator.key.php
	 ...
	 * @link http://php.net/manual/zh/apciterator.next.php
	 * @return bool Returns TRUE on success or FALSE on failure.
	 */
	 ...
	 * @link http://php.net/manual/zh/apciterator.gettotalhits.php
	 ...
	 * @link http://php.net/manual/zh/apciterator.gettotalsize.php
	...
	/**
	 * Get the total count
	 * @link http://php.net/manual/zh/apciterator.gettotalcount.php
