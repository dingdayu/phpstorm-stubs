 ...
 * @link http://php.net/manual/zh/function.mcrypt-ecb.php
 ...
 * @link http://php.net/manual/zh/function.mcrypt-cbc.php
 * @deprecated 5.5 http://www.php.net/manual/en/migration55.deprecated.php
 ...
 * @link http://php.net/manual/zh/function.mcrypt-cfb.php
 * @deprecated 5.5 http://www.php.net/manual/en/migration55.deprecated.php
 * @param int $cipher
 * @param string $key 
 * @param string $data 
 ...
 * @link http://php.net/manual/zh/function.mcrypt-ofb.php
 * @deprecated 5.5 http://www.php.net/manual/en/migration55.deprecated.php
 * @param int $cipher
 * @param string $key 
 * @param string $data 
 ...
 * @link http://php.net/manual/zh/function.mcrypt-get-key-size.php
 * @param int|string $cipher
 * @param string $mode
 * @return int 
 * @since 4.0
 ...
 * @link http://php.net/manual/zh/function.mcrypt-get-block-size.php
 * @param int $cipher <p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-get-cipher-name.php
 * @param int $cipher <p>
 * One of the MCRYPT_ciphername constants or the name
 * of the algorithm as string.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-list-algorithms.php
 ...
 * @link http://php.net/manual/zh/function.mcrypt-list-modes.php
 * @param string $lib_dir [optional] <p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-get-iv-size.php
 ...
 * @link http://php.net/manual/zh/function.mcrypt-encrypt.php
 * @param string $cipher <p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-decrypt.php
 * @param string $cipher <p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-module-open.php
 ...
 * @link http://php.net/manual/zh/function.mcrypt-generic-init.php
 * @param resource $td <p>
...
/**
 * Decrypt data
 * @link http://php.net/manual/zh/function.mdecrypt-generic.php
 * @param resource $td <p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-generic-end.php
 * @param resource $td 
 * @return bool
 ...
 * @link http://php.net/manual/zh/function.mcrypt-generic-deinit.php
 * @param resource $td <p>
 * The encryption descriptor.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-enc-self-test.php
 * @param resource $td <p>
 * The encryption descriptor.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-enc-is-block-algorithm-mode.php
 * @param resource $td <p>
 * The encryption descriptor.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-enc-is-block-algorithm.php
 * @param resource $td <p>
 * The encryption descriptor.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-enc-is-block-mode.php
 * @param resource $td <p>
 * The encryption descriptor.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-enc-get-block-size.php
 * @param resource $td <p>
 * The encryption descriptor.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-enc-get-key-size.php
 * @param resource $td <p>
 * The encryption descriptor.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-enc-get-supported-key-sizes.php
 * @param resource $td <p>
 * The encryption descriptor.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-enc-get-iv-size.php
 * @param resource $td <p>
 * The encryption descriptor.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-enc-get-algorithms-name.php
 * @param resource $td <p>
 * The encryption descriptor.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-enc-get-modes-name.php
 * @param resource $td <p>
 * The encryption descriptor.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-module-self-test.php
 * @param string $algorithm <p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-module-is-block-algorithm-mode.php
 * @param string $mode <p>
 * The mode to check.
 * </p>
 * @param string $lib_dir [optional] <p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-module-is-block-algorithm.php
 * @param string $algorithm <p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-module-is-block-mode.php
 * @param string $mode <p>
 * The mode to check.
 * </p>
 * @param string $lib_dir [optional] <p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-module-get-algo-block-size.php
 * @param string $algorithm <p>
 * The algorithm name.
 * </p>
 * @param string $lib_dir [optional] <p>
...
/**
 * Returns the maximum supported keysize of the opened mode
 * @link http://php.net/manual/zh/function.mcrypt-module-get-algo-key-size.php
 * @param string $algorithm <p>
 * The algorithm name.
 * </p>
 * @param string $lib_dir [optional] <p>
...
/**
 * Returns an array with the supported keysizes of the opened algorithm
 * @link http://php.net/manual/zh/function.mcrypt-module-get-supported-key-sizes.php
 * @param string $algorithm <p>
 ...
 * @link http://php.net/manual/zh/function.mcrypt-module-close.php
 * @param resource $td <p>
 * The encryption descriptor.
 * </p>
 * @return bool true on success or false on failure.
