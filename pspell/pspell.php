 ...
 * @link http://php.net/manual/zh/function.pspell-new.php
 ...
 * @link http://php.net/manual/zh/function.pspell-new-personal.php
 ...
 * @link http://php.net/manual/zh/function.pspell-new-config.php
 * @param int $config <p>
...
/**
 * Check a word
 * @link http://php.net/manual/zh/function.pspell-check.php
 ...
 * @link http://php.net/manual/zh/function.pspell-suggest.php
 * @param int $dictionary_link
 * @param string $word <p>
 * The tested word.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.pspell-store-replacement.php
 ...
 * @link http://php.net/manual/zh/function.pspell-add-to-personal.php
 * @param int $dictionary_link
 * @param string $word <p>
 * The added word.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.pspell-add-to-session.php
 * @param int $dictionary_link
 * @param string $word <p>
 * The added word.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.pspell-clear-session.php
 * @param int $dictionary_link
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 * @since 4.0.2
 * @since 5.0
 ...
 * @link http://php.net/manual/zh/function.pspell-save-wordlist.php
 * @param int $dictionary_link <p>
 * A dictionary link identifier opened with
 * <b>pspell_new_personal</b>.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.pspell-config-create.php
 * @param string $language <p>
 * The language parameter is the language code which consists of the
 * two letter ISO 639 language code and an optional two letter ISO
 * 3166 country code after a dash or underscore.
 ...
 * @link http://php.net/manual/zh/function.pspell-config-runtogether.php
 * @param int $dictionary_link
 * @param bool $flag <p>
 ...
 * @link http://php.net/manual/zh/function.pspell-config-mode.php
 * @param int $dictionary_link
 * @param int $mode <p>
 * The mode parameter is the mode in which spellchecker will work.
 * There are several modes available:
 ...
 * @link http://php.net/manual/zh/function.pspell-config-ignore.php
 * @param int $dictionary_link
 * @param int $n <p>
 ...
 * @link http://php.net/manual/zh/function.pspell-config-personal.php
 * @param int $dictionary_link
 * @param string $file <p>
 ...
 * @link http://php.net/manual/zh/function.pspell-config-dict-dir.php
 * @param int $conf
 ...
 * @link http://php.net/manual/zh/function.pspell-config-data-dir.php
 * @param int $conf
 * @param string $directory
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 * @since 5.0
 ...
 * @link http://php.net/manual/zh/function.pspell-config-repl.php
 * @param int $dictionary_link
 * @param string $file <p>
 * The file should be writable by whoever PHP runs as (e.g. nobody).
 * </p>
 ...
 * @link http://php.net/manual/zh/function.pspell-config-save-repl.php
 * @param int $dictionary_link
 * @param bool $flag <p>
