 ...
 * @link http://php.net/manual/zh/function.pfsockopen.php
 ...
 * @link http://php.net/manual/zh/function.crypt.php
 * @param string $str <p>
 ...
 * @link http://php.net/manual/zh/class.dir.php
 * @param $directory
 ...
 * @link http://php.net/manual/zh/function.filectime.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
...
/**
 * Gets file group
 * @link http://php.net/manual/zh/function.filegroup.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
...
/**
 * Gets file owner
 * @link http://php.net/manual/zh/function.fileowner.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.fileperms.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.file-exists.php
 * @param string $filename <p>
 ...
 * @link http://php.net/manual/zh/function.is-writable.php
 * @param string $filename <p>
 ...
 * @link http://php.net/manual/zh/function.is-writeable.php
 * @param string $filename <p>
 * The filename being checked.
 * </p>
 * @return bool true if the filename exists and is
 ...
 * @link http://php.net/manual/zh/function.is-readable.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 * @return bool true if the file or directory specified by
 ...
 * @link http://php.net/manual/zh/function.is-executable.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.is-file.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.is-dir.php
 * @param string $filename <p>
 ...
 * @link http://php.net/manual/zh/function.is-link.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
...
/**
 * Changes file owner
 * @link http://php.net/manual/zh/function.chown.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 * @param mixed $user <p>
...
/**
 * Changes file group
 * @link http://php.net/manual/zh/function.chgrp.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 * @param mixed $group <p>
 ...
 * @link http://php.net/manual/zh/function.lchown.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 * @param mixed $user <p>
 ...
 * @link http://php.net/manual/zh/function.lchgrp.php
 * @param string $filename <p>
 * Path to the symlink.
 * </p>
 * @param mixed $group <p>
...
/**
 * Changes file mode
 * @link http://php.net/manual/zh/function.chmod.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 * @param int $mode <p>
 ...
 * @link http://php.net/manual/zh/function.touch.php
 * @param string $filename <p>
 ...
 * @link http://php.net/manual/zh/function.clearstatcache.php
 ...
 * @link http://php.net/manual/zh/function.disk-total-space.php
 * @param string $directory <p>
 ...
 * @link http://php.net/manual/zh/function.disk-free-space.php
 * @param string $directory <p>
 * A directory of the filesystem or disk partition.
 * </p>
 * <p>
 ...
 * @link http://php.net/manual/zh/function.diskfreespace.php
 * @param $path
 * @since 4.0
 * @since 5.0
 */
...
/**
 * Send mail
 * @link http://php.net/manual/zh/function.mail.php
 * @param string $to <p>
 ...
 * @link http://php.net/manual/zh/function.ezmlm-hash.php
 * @param string $addr <p>
 ...
 * @link http://php.net/manual/zh/function.openlog.php
