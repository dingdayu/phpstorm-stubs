 ...
 * @link http://php.net/manual/zh/function.call-user-method.php
 ...
 * @link http://php.net/manual/zh/function.call-user-method-array.php
 ...
 * @link http://php.net/manual/zh/function.forward-static-call.php
 * @param callback $function <p>
 ...
 * @link http://php.net/manual/zh/function.forward-static-call-array.php
 * @param callback $function <p>
 * The function or method to be called. This parameter may be an &array;,
 * with the name of the class, and the method, or a &string;, with a function
 * name.
 ...
 * @link http://php.net/manual/zh/function.serialize.php
 * @param mixed $value <p>
 ...
 * @link http://php.net/manual/zh/function.unserialize.php
 * @param string $str <p>
 ...
 * @link http://php.net/manual/zh/function.var-dump.php
 ...
 * @link http://php.net/manual/zh/function.var-export.php
 * @param mixed $expression <p>
 * The variable you want to export.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.debug-zval-dump.php
 ...
 * @link http://php.net/manual/zh/function.print-r.php
 * @param mixed $expression <p>
 ...
 * @link http://php.net/manual/zh/function.memory-get-usage.php
 ...
 * @link http://php.net/manual/zh/function.memory-get-peak-usage.php
 * @param bool $real_usage [optional] <p>
 * Set this to true to get the real size of memory allocated from
 * system. If not set or false only the memory used by
 * emalloc() is reported.
 ...
 * @link http://php.net/manual/zh/function.register-tick-function.php
 * @param callback $function <p>
 ...
 * @link http://php.net/manual/zh/function.unregister-tick-function.php
 ...
 * @link http://php.net/manual/zh/function.highlight-file.php
 ...
 * @link http://php.net/manual/zh/function.show-source.php
 * @param $file_name
 ...
 * @link http://php.net/manual/zh/function.highlight-string.php
 * @param string $str <p>
 ...
 * @link http://php.net/manual/zh/function.php-strip-whitespace.php
 * @param string $filename <p>
 ...
 * @link http://php.net/manual/zh/function.ini-get-all.php
 ...
 * @link http://php.net/manual/zh/function.ini-set.php
 * @param string $varname <p>
 * </p>
 * <p>
 ...
 * @link http://php.net/manual/zh/function.ini-alter.php
 * @param $varname
 * @param $newvalue
 * @since 4.0
 * @since 5.0
 ...
 * @link http://php.net/manual/zh/function.ini-restore.php
 * @param string $varname <p>
 * The configuration option name.
 * </p>
 * @return void 
 ...
 * @link http://php.net/manual/zh/function.get-include-path.php
 ...
 * @link http://php.net/manual/zh/function.set-include-path.php
 ...
 * @link http://php.net/manual/zh/function.restore-include-path.php
 * @return void 
 * @since 4.3.0
 * @since 5.0
 */
 ...
 * @link http://php.net/manual/zh/function.setrawcookie.php
 * @param string $name 
 ...
 * @link http://php.net/manual/zh/function.header-remove.php
 ...
 * @link http://php.net/manual/zh/function.headers-sent.php
 ...
 * @link http://php.net/manual/zh/function.headers-list.php
 ...
 * @link http://php.net/manual/zh/function.connection-aborted.php
 ...
 * @link http://php.net/manual/zh/function.connection-status.php
 ...
 * @link http://php.net/manual/zh/function.parse-ini-file.php
 * @param string $filename <p>
 ...
 * @link http://php.net/manual/zh/function.parse-ini-string.php
 * @param string $ini <p>
 ...
 * @link http://php.net/manual/zh/function.gethostbyaddr.php
 ...
 * @link http://php.net/manual/zh/function.gethostbyname.php
 ...
 * @since 5.0
   name
 * @link http://php.net/manual/zh/function.gethostbynamel.php
 * @param string $hostname <p>
 * The host name.
 * </p>
...
/**
 * Gets the host name
 * @link http://php.net/manual/zh/function.gethostname.php
 ...
 * @link http://php.net/manual/zh/function.dns-check-record.php
 * @param $host <p>
 ...
 * @link http://php.net/manual/zh/function.dns-get-mx.php
 * @param $hostname
 * @param $mxhosts
 ...
 * @link http://php.net/manual/zh/function.getmxrr.php
 * @param string $hostname <p>
 ...
 * @link http://php.net/manual/zh/function.dns-get-record.php
 * @param string $hostname <p>
