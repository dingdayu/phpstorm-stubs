...
class php_user_filter  {
    ...
    /**
     * @link http://php.net/manual/zh/php-user-filter.filter.php
    ...
    /**
     * @link http://php.net/manual/zh/php-user-filter.oncreate.php
     * @return bool
     */
    ...
    /**
     * @link http://php.net/manual/zh/php-user-filter.onclose.php
     */
...
/**
 * Delay execution
 * @link http://php.net/manual/zh/function.sleep.php
 * @param int $seconds <p>
 ...
 * @link http://php.net/manual/zh/function.usleep.php
 ...
 * @link http://php.net/manual/zh/function.time-nanosleep.php
 * @param int $seconds <p>
 ...
 * @link http://php.net/manual/zh/function.time-sleep-until.php
 ...
 * @link http://php.net/manual/zh/function.strptime.php
 * @param string $date <p>
 ...
 * @link http://php.net/manual/zh/function.htmlspecialchars.php
 ...
 * @link http://php.net/manual/zh/function.htmlentities.php
 * @param string $string <p>
 * The input string.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.html-entity-decode.php
 * @param string $string <p>
 * The input string.
 * </p>
 * @param int $quote_style [optional] <p>
 ...
 * @link http://php.net/manual/zh/function.htmlspecialchars-decode.php
 * @param string $string <p>
 ...
 * @link http://php.net/manual/zh/function.get-html-translation-table.php
 ...
 * @link http://php.net/manual/zh/function.sha1.php
 * @param string $str <p>
 * The input string.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.sha1-file.php
 ...
 * @link http://php.net/manual/zh/function.md5.php
 * @param string $str <p>
 * The string.
 * </p>
 * @param bool $raw_output [optional] <p>
 ...
 * @link http://php.net/manual/zh/function.crc32.php
 * @param string $str <p>
 * The data.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.iptcparse.php
 ...
 * @link http://php.net/manual/zh/function.iptcembed.php
 ...
 * @link http://php.net/manual/zh/function.getimagesize.php
 * @param string $filename <p>
 ...
 * @link http://php.net/manual/zh/function.image-type-to-mime-type.php
 ...
 * @link http://php.net/manual/zh/function.image-type-to-extension.php
 * @param int $imagetype <p>
 ...
 * @link http://php.net/manual/zh/function.phpinfo.php
 ...
 * @link http://php.net/manual/zh/function.phpversion.php
 ...
 * @link http://php.net/manual/zh/function.phpcredits.php
 ...
 * Gets the logo guid
 * @link http://php.net/manual/zh/function.php-logo-guid.php
 ...
 * @deprecated 5.5 Removed in PHP 5.5
 * Gets the Zend guid
 * @link http://php.net/manual/zh/function.zend-logo-guid.php
 ...
 * @link http://php.net/manual/zh/function.php-uname.php
 ...
 * @link http://php.net/manual/zh/function.strnatcmp.php
 * @param string $str1 <p>
 * The first string.
 * </p>
 * @param string $str2 <p>
 ...
 * @link http://php.net/manual/zh/function.strnatcasecmp.php
 * @param string $str1 <p>
 * The first string.
 * </p>
 * @param string $str2 <p>
