 ...
 * @link http://php.net/manual/zh/function.nl-langinfo.php
 * @param int $item <p>
 ...
 * @link http://php.net/manual/zh/function.soundex.php
 * @param string $str <p>
 * The input string.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.levenshtein.php
 ...
 * @link http://php.net/manual/zh/function.str-getcsv.php
 ...
 * @see rtrim()
 * @link http://php.net/manual/zh/function.chop.php
 ...
 * @link http://php.net/manual/zh/function.strchr.php
 ...
 * @link http://php.net/manual/zh/function.sprintf.php
 ...
 * @link http://php.net/manual/zh/function.printf.php
 * @param string $format <p>
...
/**
 * Output a formatted string
 * @link http://php.net/manual/zh/function.vprintf.php
 * @param string $format <p>
 * See sprintf for a description of
 * format.
 * </p>
...
/**
 * Return a formatted string
 * @link http://php.net/manual/zh/function.vsprintf.php
 * @param string $format <p>
 * See sprintf for a description of
 * format.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.fprintf.php
...
/**
 * Write a formatted string to a stream
 * @link http://php.net/manual/zh/function.vfprintf.php
 ...
 * @link http://php.net/manual/zh/function.sscanf.php
 * @param string $str <p>
 ...
 * @link http://php.net/manual/zh/function.fscanf.php
 * @param resource $handle &fs.file.pointer;
 * @param string $format <p>
 ...
 * @link http://php.net/manual/zh/function.rawurlencode.php
 * @param string $str <p>
 ...
 * @link http://php.net/manual/zh/function.rawurldecode.php
 * @param string $str <p>
 ...
 * @link http://php.net/manual/zh/function.http-build-query.php
 ...
 * @link http://php.net/manual/zh/function.readlink.php
 * @param string $path <p>
 ...
 * @link http://php.net/manual/zh/function.linkinfo.php
 * @param string $path <p>
 * Path to the link.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.symlink.php
...
/**
 * Create a hard link
 * @link http://php.net/manual/zh/function.link.php
...
/**
 * Deletes a file
 * @link http://php.net/manual/zh/function.unlink.php
 ...
 * @link http://php.net/manual/zh/function.system.php
 * @param string $command <p>
 * The command that will be executed.
 * </p>
 * @param int $return_var [optional] <p>
 ...
 * @link http://php.net/manual/zh/function.escapeshellcmd.php
 * @param string $command <p>
 ...
 * @link http://php.net/manual/zh/function.escapeshellarg.php
 * @param string $arg <p>
 ...
 * @link http://php.net/manual/zh/function.proc-open.php
 * @param string $cmd <p>
 ...
 * @link http://php.net/manual/zh/function.proc-close.php
 ...
 * @link http://php.net/manual/zh/function.proc-terminate.php
 * @param resource $process <p>
 * The proc_open resource that will
 * be closed.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.proc-get-status.php
 * @param resource $process <p>
 * The proc_open resource that will
 * be evaluated.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.proc-nice.php
 ...
 * @link http://php.net/manual/zh/function.rand.php
 * @param $min [optional]
 * @param $max [optional]
 ...
 * @link http://php.net/manual/zh/function.srand.php
 ...
 * @link http://php.net/manual/zh/function.getrandmax.php
 ...
 * @link http://php.net/manual/zh/function.mt-rand.php
 * @param $min [optional]
 * @param $max [optional]
 ...
 * @link http://php.net/manual/zh/function.mt-srand.php
 * @param int $seed [optional] <p>
...
/**
 * Show largest possible random value
 * @link http://php.net/manual/zh/function.mt-getrandmax.php
 ...
 * @link http://php.net/manual/zh/function.getservbyname.php
 ...
 * @link http://php.net/manual/zh/function.getservbyport.php
 * @param int $port <p>
 * The port number.
 * </p>
 * @param string $protocol <p>
 ...
 * @link http://php.net/manual/zh/function.getprotobyname.php
 * @param string $name <p>
 * The protocol name.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.getprotobynumber.php
 * @param int $number <p>
 * The protocol number.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.getmyuid.php
 ...
 * @link http://php.net/manual/zh/function.getmygid.php
 ...
 * @link http://php.net/manual/zh/function.getmypid.php
 ...
 * @link http://php.net/manual/zh/function.getmyinode.php
