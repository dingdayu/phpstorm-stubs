 ...
 * @link http://php.net/manual/zh/function.getlastmod.php
 ...
 * @link http://php.net/manual/zh/function.base64-decode.php
 * @param string $data <p>
 * The encoded data.
 * </p>
...
/**
 * Uuencode a string
 * @link http://php.net/manual/zh/function.convert-uuencode.php
 * @param string $data <p>
 ...
 * @link http://php.net/manual/zh/function.convert-uudecode.php
 * @param string $data <p>
 * The uuencoded data.
 * </p>
...
/**
 * Absolute value
 * @link http://php.net/manual/zh/function.abs.php
 ...
 * @link http://php.net/manual/zh/function.floor.php
 * @param float $value <p>
 ...
 * @link http://php.net/manual/zh/function.round.php
 * @param float $val <p>
 * The value to round
 * </p>
...
/**
 * Sine
 * @link http://php.net/manual/zh/function.sin.php
 * @param float $arg <p>
 * A value in radians
 * </p>
...
/**
 * Cosine
 * @link http://php.net/manual/zh/function.cos.php
 * @param float $arg <p>
 * An angle in radians 
 * </p>
...
/**
 * Tangent
 * @link http://php.net/manual/zh/function.tan.php
 * @param float $arg <p>
...
/**
 * Arc sine
 * @link http://php.net/manual/zh/function.asin.php
 * @param float $arg <p>
...
/**
 * Arc cosine
 * @link http://php.net/manual/zh/function.acos.php
 * @param float $arg <p>
 * The argument to process
 * </p>
...
/**
 * Arc tangent
 * @link http://php.net/manual/zh/function.atan.php
 * @param float $arg <p>
 * The argument to process
 * </p>
 ...
 * @link http://php.net/manual/zh/function.atanh.php
 * @param float $arg <p>
 * The argument to process
 * </p>
 ...
 * @link http://php.net/manual/zh/function.atan2.php
 * @param float $y <p>
 * Dividend parameter
 * </p>
 * @param float $x <p>
...
/**
 * Hyperbolic sine
 * @link http://php.net/manual/zh/function.sinh.php
 * @param float $arg <p>
 * The argument to process
 * </p>
...
/**
 * Hyperbolic cosine
 * @link http://php.net/manual/zh/function.cosh.php
 * @param float $arg <p>
 * The argument to process
 * </p>
...
/**
 * Hyperbolic tangent
 * @link http://php.net/manual/zh/function.tanh.php
 * @param float $arg <p>
 * The argument to process
 * </p>
 ...
 * @link http://php.net/manual/zh/function.asinh.php
 * @param float $arg <p>
 * The argument to process
 * </p>
 ...
 * @link http://php.net/manual/zh/function.acosh.php
 * @param float $arg <p>
 ...
 * @link http://php.net/manual/zh/function.expm1.php
 * @param float $arg <p>
 * The argument to process
 * </p>
 ...
 * @link http://php.net/manual/zh/function.log1p.php
...
/**
 * Get value of pi
 * @link http://php.net/manual/zh/function.pi.php
 ...
 * @link http://php.net/manual/zh/function.is-finite.php
 * @param float $val <p>
 * The value to check
 * </p>
 ...
 * @link http://php.net/manual/zh/function.is-nan.php
 * @param float $val <p>
 * The value to check
 * </p>
...
/**
 * Integer division
 * @link http://php.net/manual/zh/function.intdiv.php
 ...
 * @link http://php.net/manual/zh/function.is-infinite.php
 * @param float $val <p>
 * The value to check
 * </p>
 ...
 * @link http://php.net/manual/zh/function.pow.php
 * @param number $base <p>
 * The base to use
 * </p>
 * @param number $exp <p>
 ...
 * @link http://php.net/manual/zh/function.exp.php
 * @param float $arg <p>
 * The argument to process
 * </p>
...
/**
 * Natural logarithm
 * @link http://php.net/manual/zh/function.log.php
 * @param float $arg <p>
...
/**
 * Base-10 logarithm
 * @link http://php.net/manual/zh/function.log10.php
 * @param float $arg <p>
 * The argument to process
 * </p>
...
/**
 * Square root
 * @link http://php.net/manual/zh/function.sqrt.php
 * @param float $arg <p>
 * The argument to process
 * </p>
 ...
 * @link http://php.net/manual/zh/function.hypot.php
 * @param float $x <p>
 ...
 * @link http://php.net/manual/zh/function.deg2rad.php
 * @param float $number <p>
 ...
 * @link http://php.net/manual/zh/function.rad2deg.php
 * @param float $number <p>
 * A radian value
 * </p>
...
/**
 * Binary to decimal
 * @link http://php.net/manual/zh/function.bindec.php
 ...
 * @link http://php.net/manual/zh/function.hexdec.php
...
/**
 * Octal to decimal
 * @link http://php.net/manual/zh/function.octdec.php
...
/**
 * Decimal to binary
 * @link http://php.net/manual/zh/function.decbin.php
 * @param int $number <p>
...
/**
 * Decimal to octal
 * @link http://php.net/manual/zh/function.decoct.php
 * @param int $number <p>
 * Decimal value to convert
 * </p>
 ...
 * @link http://php.net/manual/zh/function.dechex.php
 * @param int $number <p>
 * Decimal value to convert
 * </p>
 ...
 * @link http://php.net/manual/zh/function.base-convert.php
 ...
 * @since 5.0
  of the arguments
 * @link http://php.net/manual/zh/function.fmod.php
 * @param float $x <p>
 * The dividend
 * </p>
 * @param float $y <p>
 ...
 * @link http://php.net/manual/zh/function.inet-ntop.php
 ...
 * @link http://php.net/manual/zh/function.inet-pton.php
 ...
 * @link http://php.net/manual/zh/function.ip2long.php
 ...
 * @link http://php.net/manual/zh/function.long2ip.php
 ...
 * @link http://php.net/manual/zh/function.getenv.php
 ...
 * @link http://php.net/manual/zh/function.putenv.php
 ...
 * @link http://php.net/manual/zh/function.getopt.php
 ...
 * @link http://php.net/manual/zh/function.sys-getloadavg.php
...
/**
 * Get current time
 * @link http://php.net/manual/zh/function.gettimeofday.php
 ...
 * @link http://php.net/manual/zh/function.getrusage.php
 ...
 * @link http://php.net/manual/zh/function.uniqid.php
 ...
 * @link http://php.net/manual/zh/function.quoted-printable-decode.php
 * @param string $str <p>
 * The input string.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.quoted-printable-encode.php
 * @param string $str <p>
 * The input string.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.convert-cyr-string.php
 * @param string $str <p>
 ...
 * @link http://php.net/manual/zh/function.get-current-user.php
 ...
 * @link http://php.net/manual/zh/function.set-time-limit.php
 * @param int $seconds <p>
 ...
 * @link http://php.net/manual/zh/function.get-cfg-var.php
 ...
 * @link http://php.net/manual/zh/function.magic-quotes-runtime.php
 * @deprecated 5.3.0
 * @param $new_setting
 * @since 4.0
 * @since 5.0
 ...
 * @link http://php.net/manual/zh/function.set-magic-quotes-runtime.php
 * @deprecated 5.3.0
 ...
 * @link http://php.net/manual/zh/function.get-magic-quotes-gpc.php
 ...
 * @link http://php.net/manual/zh/function.get-magic-quotes-runtime.php
 ...
 * @link http://php.net/manual/zh/function.import-request-variables.php
 ...
 * @link http://php.net/manual/zh/function.error-log.php
