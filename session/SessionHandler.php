...
interface SessionHandlerInterface {
	...
	/**
	 * Close the session
	 * @link http://php.net/manual/zh/sessionhandlerinterface.close.php
	 * @return bool <p>
	...
	/**
	 * Destroy a session
	 * @link http://php.net/manual/zh/sessionhandlerinterface.destroy.php
	 ...
	 * @link http://php.net/manual/zh/sessionhandlerinterface.gc.php
	...
	/**
	 * Initialize session
	 * @link http://php.net/manual/zh/sessionhandlerinterface.open.php
	...
	/**
	 * Read session data
	 * @link http://php.net/manual/zh/sessionhandlerinterface.read.php
	...
	/**
	 * Write session data
	 * @link http://php.net/manual/zh/sessionhandlerinterface.write.php
 ...
 * @link http://php.net/manual/zh/class.reflectionzendextension.php
 * @since 5.4.0
 */
class SessionHandler implements SessionHandlerInterface {
	...
	/**
	 * Close the session
	 * @link http://php.net/manual/zh/sessionhandler.close.php
	 * @return bool <p>
	 * The return value (usually TRUE on success, FALSE on failure).
	 * Note this value is returned internally to PHP for processing.
	 * </p>
     ...
     * @link http://php.net/manual/zh/sessionhandler.create-sid.php
	...
	/**
	 * Destroy a session
	 * @link http://php.net/manual/zh/sessionhandler.destroy.php
	 * @param string $session_id The session ID being destroyed.
	 * @return bool <p>
	 * The return value (usually TRUE on success, FALSE on failure).
	 * Note this value is returned internally to PHP for processing.
	...
	/**
	 * Cleanup old sessions
	 * @link http://php.net/manual/zh/sessionhandler.gc.php
	 * @param int $maxlifetime <p>
	 * Sessions that have not updated for
	 * the last maxlifetime seconds will be removed.
	 * </p>
	...
	/**
	 * Initialize session
	 * @link http://php.net/manual/zh/sessionhandler.open.php
	 * @param string $save_path The path where to store/retrieve the session.
	...
	/**
	 * Read session data
	 * @link http://php.net/manual/zh/sessionhandler.read.php
	 * @param string $session_id The session id to read data for.
	 * @return string <p>
	 * Returns an encoded string of the read data.
	 * If nothing was read, it must return an empty string.
	...
	/**
	 * Write session data
	 * @link http://php.net/manual/zh/sessionhandler.write.php
	 * @param string $session_id The session id.
	 * @param string $session_data <p>
	 * The encoded session data. This data is the
	 * result of the PHP internally encoding
