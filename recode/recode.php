 ...
 * @link http://php.net/manual/zh/function.recode-string.php
 ...
 * @link http://php.net/manual/zh/function.recode-file.php
 * @param string $request <p>
 * The desired recode request type
 * </p>
 ...
 * @link http://php.net/manual/zh/function.recode.php
 * @param $request
 * @param $str
 * @since 4.0
 * @since 5.0
