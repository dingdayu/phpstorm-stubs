 ...
 * @link http://php.net/manual/zh/class.sqlite3.php
 */
class SQLite3  {

	/**
	 * Opens an SQLite database
	 * @link http://php.net/manual/zh/sqlite3.open.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3.close.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3.exec.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3.version.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3.lastinsertrowid.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3.lasterrorcode.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3.lasterrormsg.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3.busytimeout.php
	 * @param int $msecs <p>
	 ...
	 * @link http://php.net/manual/zh/sqlite3.loadextension.php
...
deleted) by the most recent SQL statement
	 * @link http://php.net/manual/zh/sqlite3.changes.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3.escapestring.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3.prepare.php
	 * @param string $query <p>
	 ...
	 * @link http://php.net/manual/zh/sqlite3.query.php
	 * @param string $query <p>
	 ...
	 * @link http://php.net/manual/zh/sqlite3.querysingle.php
	 * @param string $query <p>
	 * The SQL query to execute.
	 * </p>
	 ...
	 * @link http://php.net/manual/zh/sqlite3.createfunction.php
	 * @param string $name <p>
	 ...
	 * @link http://php.net/manual/zh/sqlite3.createaggregate.php
	 * @param string $name <p>
	 ...
	 * @link http://php.net/manual/zh/sqlite3.createcollation.php
	 * @param string $name <p>
	 ...
	 * @link http://php.net/manual/zh/sqlite3.construct.php
	 * @param string $filename <p>
	 * Path to the SQLite database, or :memory: to use in-memory database.
	 * </p>
	 * @param int $flags [optional] <p>
 ...
 * @link http://php.net/manual/zh/class.sqlite3stmt.php
 */
class SQLite3Stmt  {

	/**
	 * Returns the number of parameters within the prepared statement
	 * @link http://php.net/manual/zh/sqlite3stmt.paramcount.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3stmt.close.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3stmt.reset.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3stmt.clear.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3stmt.execute.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3stmt.bindparam.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3stmt.bindvalue.php
	 * @param string $sql_param <p>
	 * An string identifying the statement variable to which the
 ...
 * @link http://php.net/manual/zh/class.sqlite3result.php
 */
class SQLite3Result  {

	/**
	 * Returns the number of columns in the result set
	 * @link http://php.net/manual/zh/sqlite3result.numcolumns.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3result.columnname.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3result.columntype.php
	 * @param int $column_number <p>
	 * The numeric zero-based index of the column.
	 * </p>
	 ...
	 * @link http://php.net/manual/zh/sqlite3result.fetcharray.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3result.reset.php
	 ...
	 * @link http://php.net/manual/zh/sqlite3result.finalize.php
	 * @return bool <b>TRUE</b>.
	 * @since 5.3.0
	 */
 ...
 * @link http://php.net/manual/zh/sqlite3.constants.php
 */
