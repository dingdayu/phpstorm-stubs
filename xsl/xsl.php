...
/**
 * @link http://php.net/manual/zh/class.xsltprocessor.php
 */
class XSLTProcessor  {

	/**
	 * Import stylesheet
	 * @link http://php.net/manual/zh/xsltprocessor.importstylesheet.php
	 ...
	 * @link http://php.net/manual/zh/xsltprocessor.transformtodoc.php
	 * @param DOMNode $doc <p>
	...
	/**
	 * Transform to URI
	 * @link http://php.net/manual/zh/xsltprocessor.transformtouri.php
	...
	/**
	 * Transform to XML
	 * @link http://php.net/manual/zh/xsltprocessor.transformtoxml.php
	 * @param DOMDocument|SimpleXMLElement $doc <p>
	 ...
	 * @link http://php.net/manual/zh/xsltprocessor.setparameter.php
	 ...
	 * @link http://php.net/manual/zh/xsltprocessor.getparameter.php
	...
	/**
	 * Remove parameter
	 * @link http://php.net/manual/zh/xsltprocessor.removeparameter.php
	 * @param string $namespaceURI <p>
	 * The namespace URI of the XSLT parameter.
	 * </p>
	 * @param string $localName <p>
	 ...
	 * @link http://php.net/manual/zh/xsltprocessor.hasexsltsupport.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 * @since 5.0.4
	 */
	 ...
	 * @link http://php.net/manual/zh/xsltprocessor.registerphpfunctions.php
	 ...
	 * @link http://php.net/manual/zh/xsltprocessor.setprofiling.php
	 ...
	 * @link http://php.net/manual/zh/xsltprocessor.setsecurityprefs.php
	 ...
	 * @link http://php.net/manual/zh/xsltprocessor.getsecurityprefs.php
	 * @return int
	 * @since 5.4.0
	 */
...
/** @link http://php.net/manual/zh/xsl.constants.php */
