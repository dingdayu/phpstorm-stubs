 ...
 * @link http://php.net/manual/zh/function.ibase-connect.php
 ...
 * @link http://php.net/manual/zh/function.ibase-pconnect.php
 * @param string $database [optional] <p>
 * The database argument has to be a valid path to
 * database file on the server it resides on. If the server is not local,
 * it must be prefixed with either 'hostname:' (TCP/IP), '//hostname/'
 ...
 * @link http://php.net/manual/zh/function.ibase-close.php
...
/**
 * Drops a database
 * @link http://php.net/manual/zh/function.ibase-drop-db.php
 ...
 * @link http://php.net/manual/zh/function.ibase-query.php
 ...
 * @link http://php.net/manual/zh/function.ibase-fetch-row.php
 ...
 * @link http://php.net/manual/zh/function.ibase-fetch-assoc.php
 ...
 * @link http://php.net/manual/zh/function.ibase-fetch-object.php
...
/**
 * Free a result set
 * @link http://php.net/manual/zh/function.ibase-free-result.php
 * @param resource $result_identifier <p>
 ...
 * @link http://php.net/manual/zh/function.ibase-name-result.php
 * @param resource $result <p>
 ...
 * @link http://php.net/manual/zh/function.ibase-prepare.php
 * @param string $query <p>
 * An InterBase query.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.ibase-execute.php
 ...
 * @link http://php.net/manual/zh/function.ibase-free-query.php
 * @param resource $query <p>
 ...
 * @link http://php.net/manual/zh/function.ibase-gen-id.php
 ...
 * @link http://php.net/manual/zh/function.ibase-num-fields.php
 * @param resource $result_id <p>
 * An InterBase result identifier.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.ibase-num-params.php
 * @param resource $query <p>
 ...
 * @link http://php.net/manual/zh/function.ibase-affected-rows.php
 * @param resource $link_identifier [optional] <p>
 ...
 * @link http://php.net/manual/zh/function.ibase-field-info.php
 * @param resource $result <p>
 * An InterBase result identifier.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.ibase-param-info.php
 * @param resource $query <p>
...
/**
 * Begin a transaction
 * @link http://php.net/manual/zh/function.ibase-trans.php
 ...
 * @link http://php.net/manual/zh/function.ibase-commit.php
 ...
 * @link http://php.net/manual/zh/function.ibase-rollback.php
 * @param resource $link_or_trans_identifier [optional] <p>
 ...
 * @link http://php.net/manual/zh/function.ibase-commit-ret.php
 * @param resource $link_or_trans_identifier [optional] <p>
 * If called without an argument, this function commits the default
 * transaction of the default link. If the argument is a connection
 * identifier, the default transaction of the corresponding connection
 ...
 * @link http://php.net/manual/zh/function.ibase-rollback-ret.php
 * @param resource $link_or_trans_identifier [optional] <p>
 * If called without an argument, this function rolls back the default
 * transaction of the default link. If the argument is a connection
 * identifier, the default transaction of the corresponding connection
 ...
 * @link http://php.net/manual/zh/function.ibase-blob-info.php
 ...
 * @link http://php.net/manual/zh/function.ibase-blob-create.php
 * @param resource $link_identifier [optional] <p>
 * An InterBase link identifier. If omitted, the last opened link is
 * assumed.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.ibase-blob-add.php
 ...
 * @link http://php.net/manual/zh/function.ibase-blob-cancel.php
 * @param resource $blob_handle <p>
 * A BLOB handle opened with ibase_blob_create.
 * </p>
 * @return bool true on success or false on failure.
...
/**
 * Close blob
 * @link http://php.net/manual/zh/function.ibase-blob-close.php
 * @param resource $blob_handle <p>
 ...
 * @link http://php.net/manual/zh/function.ibase-blob-open.php
 * @param resource $link_identifier <p>
 * An InterBase link identifier. If omitted, the last opened link is
 * assumed.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.ibase-blob-get.php
 * @param resource $blob_handle <p>
 ...
 * @link http://php.net/manual/zh/function.ibase-blob-echo.php
 * @param string $blob_id <p>
 * </p>
 * @return bool true on success or false on failure.
 * @since 4.0
 ...
 * @link http://php.net/manual/zh/function.ibase-blob-import.php
 * @param resource $link_identifier <p>
 * An InterBase link identifier. If omitted, the last opened link is
 * assumed.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.ibase-errmsg.php
 ...
 * @link http://php.net/manual/zh/function.ibase-errcode.php
 ...
 * @link http://php.net/manual/zh/function.ibase-add-user.php
 ...
 * @link http://php.net/manual/zh/function.ibase-modify-user.php
 * @param resource $service_handle 
 * @param string $user_name 
 * @param string $password 
 * @param string $first_name [optional] 
 ...
 * @link http://php.net/manual/zh/function.ibase-delete-user.php
 * @param resource $service_handle 
 * @param string $user_name 
 * @return bool true on success or false on failure.
 * @since 4.2.0
 ...
 * @link http://php.net/manual/zh/function.ibase-service-attach.php
 * @param string $host 
 ...
 * @link http://php.net/manual/zh/function.ibase-service-detach.php
 * @param resource $service_handle 
 * @return bool true on success or false on failure.
 * @since 5.0
 */
 ...
 * @link http://php.net/manual/zh/function.ibase-backup.php
 * @param resource $service_handle 
 ...
 * @link http://php.net/manual/zh/function.ibase-restore.php
 * @param resource $service_handle 
 ...
 * @link http://php.net/manual/zh/function.ibase-maintain-db.php
 * @param resource $service_handle 
 * @param string $db 
 * @param int $action 
 ...
 * @link http://php.net/manual/zh/function.ibase-db-info.php
 * @param resource $service_handle 
 * @param string $db 
 * @param int $action 
 * @param int $argument [optional] 
 ...
 * @link http://php.net/manual/zh/function.ibase-server-info.php
 * @param resource $service_handle 
 * @param int $action 
 * @return string 
 * @since 5.0
 ...
 * @link http://php.net/manual/zh/function.ibase-wait-event.php
 ...
 * @link http://php.net/manual/zh/function.ibase-set-event-handler.php
 ...
 * @link http://php.net/manual/zh/function.ibase-free-event-handler.php
 ...
 * @link http://php.net/manual/zh/ibase.constants.php
 */
