...
/**
 * Set cubic threshold
 * @link http://php.net/manual/zh/function.ming-setcubicthreshold.php
 ...
 * @link http://php.net/manual/zh/function.ming-setscale.php
 * @param $scale int <p>
 * The scale to be set.
 * </p>
 * @return void 
 ...
 * @link http://php.net/manual/zh/function.ming-useswfversion.php
 * @param $version int <p>
 * SWF version to use.
 * </p>
 * @return void 
 ...
 * @link http://php.net/manual/zh/function.ming-keypress.php
 * @param $char string 
...
/**
 * Use constant pool
 * @link http://php.net/manual/zh/function.ming-useconstants.php
 * @param $use int <p>
 * Its description
 * </p>
 * @return void 
 ...
 * @link http://php.net/manual/zh/function.ming-setswfcompression.php
 * @param $level int <p>
