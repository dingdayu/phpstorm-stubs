...
/**
 * The DOMNode class
 * @link http://php.net/manual/zh/class.domnode.php
 */
class DOMNode  {
     ...
     * @link http://php.net/manual/zh/class.domnode.php#domnode.props.nodename
     */
    public $nodeName;
     ...
     * @link http://php.net/manual/zh/class.domnode.php#domnode.props.nodevalue
     */
    public $nodeValue;
     ...
     * @link http://php.net/manual/zh/class.domnode.php#domnode.props.nodetype
     */
    public $nodeType;
     ...
     * @link http://php.net/manual/zh/class.domnode.php#domnode.props.parentnode
     */
    public $parentNode;
     ...
     * @link http://php.net/manual/zh/class.domnode.php#domnode.props.childnodes
     */
    public $childNodes;
     ...
     * @link http://php.net/manual/zh/class.domnode.php#domnode.props.firstchild
     */
    public $firstChild;
     ...
     * @link http://php.net/manual/zh/class.domnode.php#domnode.props.lastchild
     */
    public $lastChild;
     ...
     * @link http://php.net/manual/zh/class.domnode.php#domnode.props.previoussibling
     */
     ...
     * @link http://php.net/manual/zh/class.domnode.php#domnode.props.nextsibling
     */
    public $nextSibling;
     ...
     * @link http://php.net/manual/zh/class.domnode.php#domnode.props.attributes
     */
    public $attributes;
     ...
     * @link http://php.net/manual/zh/class.domnode.php#domnode.props.ownerdocument
     */
     ...
     * @link http://php.net/manual/zh/class.domnode.php#domnode.props.namespaceuri
     */
    public $namespaceURI;
     ...
     * @link http://php.net/manual/zh/class.domnode.php#domnode.props.prefix
     */
    public $prefix;
     ...
     * @link http://php.net/manual/zh/class.domnode.php#domnode.props.localname
     */
    public $localName;
     ...
     * @link http://php.net/manual/zh/class.domnode.php#domnode.props.baseuri
     */
    public $baseURI;
     ...
     * @link http://php.net/manual/zh/class.domnode.php#domnode.props.textcontent
     */
    public $textContent;

    /**
     * Adds a new child before a reference node
     * @link http://php.net/manual/zh/domnode.insertbefore.php
    ...
    /**
     * Replaces a child
     * @link http://php.net/manual/zh/domnode.replacechild.php
     * @param DOMNode $newnode <p>
     ...
     * @link http://php.net/manual/zh/domnode.removechild.php
     * @param DOMNode $oldnode <p>
     * The removed child.
     * </p>
     ...
     * @link http://php.net/manual/zh/domnode.appendchild.php
     * @param DOMNode $newnode <p>
     * The appended child.
     * </p>
     ...
     * @link http://php.net/manual/zh/domnode.haschildnodes.php
    ...
    /**
     * Clones a node
     * @link http://php.net/manual/zh/domnode.clonenode.php
    ...
    /**
     * Normalizes the node
     * @link http://php.net/manual/zh/domnode.normalize.php
     * @return void
     * @since 5.0
     */
     ...
     * @link http://php.net/manual/zh/domnode.issupported.php
     ...
     * @link http://php.net/manual/zh/domnode.hasattributes.php
     * @return bool true on success or false on failure.
     * @since 5.0
     */
     ...
     * @link http://php.net/manual/zh/domnode.issamenode.php
     ...
     * @link http://php.net/manual/zh/domnode.lookupprefix.php
     ...
     * @link http://php.net/manual/zh/domnode.isdefaultnamespace.php
     * @param string $namespaceURI <p>
     ...
     * @link http://php.net/manual/zh/domnode.lookupnamespaceuri.php
	 ...
	 * @link http://php.net/manual/zh/domnode.getlineno.php
 ...
 * @link http://php.net/manual/zh/class.domexception.php
 */
class DOMException extends Exception  {
     ...
     * @link http://php.net/manual/zh/class.domexception.php#domexception.props.code
     */
    public $code;
}
...
/**
 * @link http://php.net/manual/zh/ref.dom.php
 */
class DOMNameList  {
 ...
 * @link http://php.net/manual/zh/class.domimplementation.php
 */
class DOMImplementation  {

    /**
     * Creates a new DOMImplementation object
     * @link http://http://php.net/manual/zh/domimplementation.construct.php
     * @since 5.0
     */
	 ...
	 * @link http://php.net/manual/zh/domimplementation.hasfeature.php
	 * @param string $feature <p>
	 * The feature to test.
	 * </p>
	 * @param string $version <p>
     ...
     * @link http://php.net/manual/zh/domimplementation.createdocumenttype.php
     ...
     * @link http://php.net/manual/zh/domimplementation.createdocument.php
 ...
 * @link http://php.net/manual/zh/class.domdocumentfragment.php
 */
class DOMDocumentFragment extends DOMNode  {
    ...
    /**
     * Append raw XML data
     * @link http://php.net/manual/zh/domdocumentfragment.appendxml.php
     * @param string $data <p>
     * XML to append.
     * </p>
     * @return bool true on success or false on failure.
 ...
 * @link http://php.net/manual/zh/class.domnodelist.php
 */
class DOMNodeList implements Traversable {
     ...
     * @link http://php.net/manual/zh/class.domnodelist.php#domnodelist.props.length
     */
    public $length;

  /**
	 * Retrieves a node specified by index
	 * @link http://php.net/manual/zh/domnodelist.item.php
	 * @param int $index <p>
 ...
 * @link http://php.net/manual/zh/class.domnamednodemap.php
...
class DOMNamedNodeMap implements Traversable {
     ...
     * @link http://php.net/manual/zh/domnamednodemap.getnameditem.php
     * @param string $name <p>
    ...
    /**
     * Retrieves a node specified by index
     * @link http://php.net/manual/zh/domnamednodemap.item.php
     * @param int $index <p>
     * Index into this map.
     * </p>
     ...
     * @link http://php.net/manual/zh/domnamednodemap.getnameditemns.php
     * @param string $namespaceURI <p>
 ...
 * @link http://php.net/manual/zh/class.domcharacterdata.php
 */
class DOMCharacterData extends DOMNode  {
     ...
     * @link http://php.net/manual/zh/class.domcharacterdata.php#domcharacterdata.props.data
     */
    public $data;
     ...
     * @link http://php.net/manual/zh/class.domcharacterdata.php#domcharacterdata.props.length
     */
    public $length;

    /**
     * Extracts a range of data from the node
     * @link http://php.net/manual/zh/domcharacterdata.substringdata.php
     * @param int $offset <p>
     ...
     * @link http://php.net/manual/zh/domcharacterdata.appenddata.php
     * @param string $data <p>
     ...
     * @link http://php.net/manual/zh/domcharacterdata.insertdata.php
     * @param int $offset <p>
     ...
     * @link http://php.net/manual/zh/domcharacterdata.deletedata.php
     * @param int $offset <p>
     ...
     * @link http://php.net/manual/zh/domcharacterdata.replacedata.php
     * @param int $offset <p>
 ...
 * @link http://php.net/manual/zh/class.domattr.php
 */
class DOMAttr extends DOMNode
{
     ...
     * (PHP5)<br/>
     * The name of the attribute
     * @link http://php.net/manual/zh/class.domattr.php#domattr.props.name
     */
    public $name;
     ...
     * @link http://php.net/manual/zh/class.domattr.php#domattr.props.ownerelement
     */
    public $ownerElement;
     ...
     * @link http://php.net/manual/zh/class.domattr.php#domattr.props.schematypeinfo
     */
     ...
     * (PHP5)<br/>
     * Not implemented yet, always is NULL
     * @link http://php.net/manual/zh/class.domattr.php#domattr.props.specified
     */
    public $specified;
     ...
     * @link http://php.net/manual/zh/class.domattr.php#domattr.props.value
     */
    public $value;

    /**
     * Checks if attribute is a defined ID
     * @link http://php.net/manual/zh/domattr.isid.php
     * @return bool true on success or false on failure.
     * @since 5.0
     */
     ...
     * @link http://php.net/manual/zh/domattr.construct.php
     * @param $name
 ...
 * @link http://php.net/manual/zh/class.domelement.php
 */
class DOMElement extends DOMNode  {
     ...
     * @link http://php.net/manual/zh/class.domelement.php#domelement.props.schematypeinfo
     */
    public $schemaTypeInfo ;
     ...
     * @since 5.0
     * The element name
     * @link http://php.net/manual/zh/class.domelement.php#domelement.props.tagname
     */
    public $tagName ;

    /**
     * Returns value of attribute
     * @link http://php.net/manual/zh/domelement.getattribute.php
     * @param string $name <p>
     * The name of the attribute.
     * </p>
    ...
    /**
     * Adds new attribute
     * @link http://php.net/manual/zh/domelement.setattribute.php
     * @param string $name <p>
     * The name of the attribute.
     * </p>
    ...
    /**
     * Removes attribute
     * @link http://php.net/manual/zh/domelement.removeattribute.php
     * @param string $name <p>
     * The name of the attribute.
     * </p>
     * @return bool true on success or false on failure.
     ...
     * @link http://php.net/manual/zh/domelement.getattributenode.php
     * @param string $name <p>
     * The name of the attribute.
     * </p>
     ...
     * @link http://php.net/manual/zh/domelement.setattributenode.php
    ...
    /**
     * Removes attribute
     * @link http://php.net/manual/zh/domelement.removeattributenode.php
     ...
     * @link http://php.net/manual/zh/domelement.getelementsbytagname.php
     * @param string $name <p>
    ...
    /**
     * Returns value of attribute
     * @link http://php.net/manual/zh/domelement.getattributens.php
     * @param string $namespaceURI <p>
     * The namespace URI.
     * </p>
     * @param string $localName <p>
    ...
    /**
     * Adds new attribute
     * @link http://php.net/manual/zh/domelement.setattributens.php
     * @param string $namespaceURI <p>
     * The namespace URI.
     * </p>
     * @param string $qualifiedName <p>
    ...
    /**
     * Removes attribute
     * @link http://php.net/manual/zh/domelement.removeattributens.php
     * @param string $namespaceURI <p>
     * The namespace URI.
     * </p>
     * @param string $localName <p>
    ...
    /**
     * Returns attribute node
     * @link http://php.net/manual/zh/domelement.getattributenodens.php
     * @param string $namespaceURI <p>
     * The namespace URI.
     * </p>
     * @param string $localName <p>
    ...
    /**
     * Adds new attribute node to element
     * @link http://php.net/manual/zh/domelement.setattributenodens.php
     * @param DOMAttr $attr
     ...
     * @link http://php.net/manual/zh/domelement.getelementsbytagnamens.php
     * @param string $namespaceURI <p>
     * The namespace URI.
     * </p>
     * @param string $localName <p>
     ...
     * @link http://php.net/manual/zh/domelement.hasattribute.php
     * @param string $name <p>
     * The attribute name.
     * </p>
     * @return bool true on success or false on failure.
    ...
    /**
     * Checks to see if attribute exists
     * @link http://php.net/manual/zh/domelement.hasattributens.php
     * @param string $namespaceURI <p>
     * The namespace URI.
     * </p>
     * @param string $localName <p>
     ...
     * @link http://php.net/manual/zh/domelement.setidattribute.php
     * @param string $name <p>
     * The name of the attribute.
     * </p>
     * @param bool $isId <p>
     ...
     * @link http://php.net/manual/zh/domelement.setidattributens.php
     * @param string $namespaceURI <p>
     ...
     * @link http://php.net/manual/zh/domelement.setidattributenode.php
     * @param DOMAttr $attr <p>
     * The attribute node.
     * </p>
     * @param bool $isId <p>
     ...
     * @link http://php.net/manual/zh/domelement.construct.php
 ...
 * @link http://php.net/manual/zh/class.domtext.php
 */
class DOMText extends DOMCharacterData  {
     ...
     * @link http://php.net/manual/zh/class.domtext.php#domtext.props.wholeText
     */
    public $wholeText;

    /**
     * Breaks this node into two nodes at the specified offset
     * @link http://php.net/manual/zh/domtext.splittext.php
     * @param int $offset <p>
     ...
     * @link http://php.net/manual/zh/domtext.iswhitespaceinelementcontent.php
     * @return bool true on success or false on failure.
     * @since 5.0
     */
     ...
     * @link http://php.net/manual/zh/domtext.construct.php
 ...
 * @link http://php.net/manual/zh/class.domcomment.php
 */
class DOMComment extends DOMCharacterData  {

    /**
     * Creates a new DOMComment object
     * @link http://php.net/manual/zh/domcomment.construct.php
 ...
 * @link http://php.net/manual/zh/class.domdocumenttype.php
 */
class DOMDocumentType extends DOMNode
{
     ...
     * @link http://php.net/manual/zh/class.domdocumenttype.php#domdocumenttype.props.publicid
     */
    public $publicId;
     ...
     * @link http://php.net/manual/zh/class.domdocumenttype.php#domdocumenttype.props.systemid
     */
    public $systemId;
     ...
     * @link http://php.net/manual/zh/class.domdocumenttype.php#domdocumenttype.props.name
     */
    public $name;
     ...
     * @link http://php.net/manual/zh/class.domdocumenttype.php#domdocumenttype.props.entities
     */
    public $entities;
     ...
     * @link http://php.net/manual/zh/class.domdocumenttype.php#domdocumenttype.props.notations
     */
    public $notations;
     ...
     * @link http://php.net/manual/zh/class.domdocumenttype.php#domdocumenttype.props.internalsubset
     */
 ...
 * @link http://php.net/manual/zh/class.domnotation.php
 */
class DOMNotation  extends DOMNode{
     ...
     * @since 5.0
     *
     * @link http://php.net/manual/zh/class.domnotation.php#domnotation.props.publicid
     */
    public $publicId;
     ...
     * @since 5.0
     *
     * @link http://php.net/manual/zh/class.domnotation.php#domnotation.props.systemid
     */
    public $systemId;
 ...
 * @link http://php.net/manual/zh/class.domentity.php
 */
class DOMEntity extends DOMNode  {
     ...
     * @link http://php.net/manual/zh/class.domentity.php#domentity.props.publicid
     */
    public $publicId ;
     ...
     * absolute URI or not.
     * @link http://php.net/manual/zh/class.domentity.php#domentity.props.systemid
     */
    public $systemId ;
     ...
     * @link http://php.net/manual/zh/class.domentity.php#domentity.props.notationname
     */
    public $notationName ;
     ...
     * @link http://php.net/manual/zh/class.domentity.php#domentity.props.actualencoding
     */
    public $actualEncoding ;
     ...
     * @link http://php.net/manual/zh/class.domentity.php#domentity.props.encoding
     */
    public $encoding ;
     ...
     * @link http://php.net/manual/zh/class.domentity.php#domentity.props.version
     */
    public $version ;
...
/**
 * Extends DOMNode.
 * @link http://php.net/manual/zh/class.domentityreference.php
 */
class DOMEntityReference extends DOMNode  {

    /**
     * Creates a new DOMEntityReference object
     * @link http://php.net/manual/zh/domentityreference.construct.php
 ...
 * @link http://php.net/manual/zh/class.domprocessinginstruction.php
 */
class DOMProcessingInstruction extends DOMNode  {
     ...
     * @since 5.0
     *
     * @link http://php.net/manual/zh/class.domprocessinginstruction.php#domprocessinginstruction.props.target
     */
    public $target;
     ...
     * @since 5.0
     *
     * @link http://php.net/manual/zh/class.domprocessinginstruction.php#domprocessinginstruction.props.data
     */
    public $data;

    /**
     * Creates a new <classname>DOMProcessingInstruction</classname> object
     * @link http://php.net/manual/zh/domprocessinginstruction.construct.php
 ...
 * @link http://php.net/manual/zh/class.domxpath.php
 */
class DOMXPath  {
     ...
     * @since 5.0
     *
     * @link http://php.net/manual/zh/class.domxpath.php#domxpath.props.document
     */
    public $document;

    /**
     * Creates a new <classname>DOMXPath</classname> object
     * @link http://php.net/manual/zh/domxpath.construct.php
     ...
     * @link http://php.net/manual/zh/domxpath.registernamespace.php
     * @param string $prefix <p>
     * The prefix.
     * </p>
     * @param string $namespaceURI <p>
     ...
     * @link http://php.net/manual/zh/domxpath.query.php
     ...
     * @link http://php.net/manual/zh/domxpath.evaluate.php
     * @param string $expression <p>
     * The XPath expression to execute.
     * </p>
     * @param DOMNode $contextnode [optional] <p>
     ...
     * @link http://php.net/manual/zh/domxpath.registerphpfunctions.php
