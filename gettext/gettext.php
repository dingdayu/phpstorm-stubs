 ...
 * @link http://php.net/manual/zh/function.textdomain.php
 ...
 * @link http://php.net/manual/zh/function.gettext.php
 ...
 * @link http://php.net/manual/zh/function.dgettext.php
 ...
 * @link http://php.net/manual/zh/function.dcgettext.php
 * @param string $domain <p>
 * The domain
 * </p>
 * @param string $message <p>
 ...
 * @link http://php.net/manual/zh/function.bindtextdomain.php
 * @param string $domain <p>
 * The domain
 * </p>
 ...
 * @link http://php.net/manual/zh/function.ngettext.php
 * @param string $msgid1
 * @param string $msgid2
 * @param int $n
 ...
 * @link http://php.net/manual/zh/function.dngettext.php
 * @param string $domain <p>
 * The domain
 * </p>
 * @param string $msgid1
 ...
 * @link http://php.net/manual/zh/function.dcngettext.php
 * @param string $domain <p>
 * The domain
 * </p>
 * @param string $msgid1
 ...
 * @link http://php.net/manual/zh/function.bind-textdomain-codeset.php
 * @param string $domain <p>
 * The domain
 * </p>
