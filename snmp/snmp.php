 ...
 * @link http://php.net/manual/zh/class.snmp.php
 */
class SNMP  {
    /**
	 ...
	 * @link http://php.net/manual/zh/snmp.construct.php
	...
	/**
	 * Close SNMP session
	 * @link http://php.net/manual/zh/snmp.close.php
     ...
     * @link http://php.net/manual/zh/snmp.setsecurity.php
	 ...
	 * @link http://php.net/manual/zh/snmp.get.php
	 ...
	 * @link http://php.net/manual/zh/snmp.getnext.php
	 ...
	 * @link http://php.net/manual/zh/snmp.walk.php
	 ...
	 * @link http://php.net/manual/zh/snmp.set.php
	...
	/**
	 * Get last error code
	 * @link http://php.net/manual/zh/snmp.geterrno.php
	 ...
	 * @link http://php.net/manual/zh/snmp.geterror.php
 ...
 * @link http://php.net/manual/zh/class.snmpexception.php
 */
...
/**
 * Fetch an SNMP object
 * @link http://php.net/manual/zh/function.snmpget.php
 ...
 * @link http://php.net/manual/zh/function.snmpgetnext.php
 ...
 * @link http://php.net/manual/zh/function.snmpwalk.php
 * @param string $hostname <p>
 ...
 * @link http://php.net/manual/zh/function.snmprealwalk.php
 * @param string $host <p>The hostname of the SNMP agent (server).</p>
 * @param string $community <p>The read community.</p>
 * @param string $object_id <p>The SNMP object id which precedes the wanted one.</p>
 * @param int $timeout [optional] <p>The number of microseconds until the first timeout.</p>
 ...
 * @link http://php.net/manual/zh/function.snmpwalkoid.php
 * @param string $hostname <p>
 * The SNMP agent.
 * </p>
 * @param string $community <p>
...
/**
 * Set the value of an SNMP object
 * @link http://php.net/manual/zh/function.snmpset.php
 * @param string $host <p>
 ...
 * @link http://php.net/manual/zh/function.snmp-get-quick-print.php
 ...
 * @link http://php.net/manual/zh/function.snmp-set-quick-print.php
 ...
 * @link http://php.net/manual/zh/function.snmp-set-enum-print.php
 ...
 * @link http://php.net/manual/zh/function.snmp-set-oid-output-format.php
...
/**
 * Return all objects including their respective object id within the specified one
 * @link http://php.net/manual/zh/function.snmp-set-oid-numeric-print.php
...
/**
 * Fetch an SNMP object
 * @link http://php.net/manual/zh/function.snmp2-get.php
 * @param string $host <p>
 * The SNMP agent.
 * </p>
 * @param string $community <p>
...
/**
 * Fetch the SNMP object which follows the given object id
 * @link http://php.net/manual/zh/function.snmp2-getnext.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
 * @param string $community <p>
...
/**
 * Fetch all the SNMP objects from an agent
 * @link http://php.net/manual/zh/function.snmp2-walk.php
 * @param string $host <p>
 * The SNMP agent (server).
 * </p>
 * @param string $community <p>
...
/**
 * Return all objects including their respective object ID within the specified one
 * @link http://php.net/manual/zh/function.snmp2-real-walk.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
 * @param string $community <p>
...
/**
 * Set the value of an SNMP object
 * @link http://php.net/manual/zh/function.snmp2-set.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
 * @param string $community <p>
...
/**
 * Fetch an SNMP object
 * @link http://php.net/manual/zh/function.snmp3-get.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
...
/**
 * Fetch the SNMP object which follows the given object id
 * @link http://php.net/manual/zh/function.snmp3-getnext.php
 * @param string $host <p>
 * The hostname of the
 * SNMP agent (server).
 * </p>
...
/**
 * Fetch all the SNMP objects from an agent
 * @link http://php.net/manual/zh/function.snmp3-walk.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
 * @param string $sec_name <p>
...
/**
 * Return all objects including their respective object ID within the specified one
 * @link http://php.net/manual/zh/function.snmp3-real-walk.php
 * @param string $host <p>
 * The hostname of the
 * SNMP agent (server).
 * </p>
...
/**
 * Set the value of an SNMP object
 * @link http://php.net/manual/zh/function.snmp3-set.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
 * @param string $sec_name <p>
 ...
 * @link http://php.net/manual/zh/function.snmp-set-valueretrieval.php
 ...
 * @link http://php.net/manual/zh/function.snmp-get-valueretrieval.php
 ...
 * @link http://php.net/manual/zh/function.snmp-read-mib.php
...
/**
 * As of 5.4.0
 * @link http://php.net/manual/zh/snmp.constants.php
 */
