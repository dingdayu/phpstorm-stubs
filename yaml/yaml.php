 ...
 * @link http://php.net/manual/zh/yaml.constants.php
 */
 ...
 * @link http://php.net/manual/zh/function.yaml-emit-file.php
...
/**
 * (PHP 5 &gt;= 5.2.0, PECL yaml &gt;= 0.5.0)<br/>
 * @link http://php.net/manual/zh/function.yaml-emit.php
 * @param mixed $data The data being encoded. Can be any type except a resource.
 ...
 * @link http://php.net/manual/zh/function.yaml-parse-file.php
 * @param string $filename Path to the file.
 ...
 * @link http://php.net/manual/zh/function.yaml-parse-url.php
 ...
 * (PHP 5 &gt;= 5.2.0, PECL yaml &gt;= 0.4.0)<br/>
 * Parse a YAML stream
 * @link http://php.net/manual/zh/function.yaml-parse.php
