...
class IntlChar {
    ...
    /**
     * @link http://php.net/manual/zh/intlchar.charfromname.php
     ...
     * @link http://php.net/manual/zh/intlchar.foldcase.php
     * @param mixed $codepoint The integer codepoint value (e.g. 0x2603 for U+2603 SNOWMAN), or the character encoded as a UTF-8 string (e.g. "\u{2603}")
     ...
     * @link http://php.net/manual/zh/intlchar.tolower.php
