...
class MongoClient
{
     ...
     * @link http://php.net/manual/zh/mongo.construct.php
     ...
     *         connection {@link http://php.net/manual/zh/mongo.connecting.ssl.php#mongo.connecting.context.ssl context options for SSL}
     *         or {@link http://php.net/manual/zh/context.mongodb.php logging callbacks}.
     *         </p><ul>
     *         <li>
     *         <p>
     *         <em>"context"</em>
     ...
     *         {@link http://php.net/manual/zh/context.ssl.php SSL context options}. See the
     *         {@link http://php.net/manual/zh/mongo.connecting.ssl.php#mongo.connecting.context.ssl Connecting over SSL} tutorial.
     *         </p>
     *         </li>
     *         </ul>
     * @return MongoClient
     ...
     * (PECL mongo &gt;= 1.3.0)<br/>
     * Gets a database
     * @link http://php.net/manual/zh/mongoclient.get.php
     ...
     * @link http://php.net/manual/zh/mongoclient.listdbs.php
...
class Mongo extends MongoClient {
     ...
     * @link http://php.net/manual/zh/mongo.getpoolsize.php
     ...
     * @link http://php.net/manual/zh/mongo.getslave.php
     ...
     * @link http://php.net/manual/zh/mongo.getslaveokay.php
    ...
    */
     ...
     * @link http://php.net/manual/zh/mongo.pooldebug.php
     ...
     * @link http://php.net/manual/zh/mongo.setslaveokay.php
     ...
     * @link http://php.net/manual/zh/mongo.setpoolsize.php
...
class MongoDB {
	/**
	 * Profiling is off.
     * @link http://php.net/manual/zh/class.mongodb.php#mongodb.constants.profiling-off
	 */
    const PROFILING_OFF = 0;

	/**
	 * Profiling is on for slow operations (>100 ms).
     * @link http://php.net/manual/zh/class.mongodb.php#mongodb.constants.profiling-slow
	 */
    const PROFILING_SLOW = 1;

	/**
	 * Profiling is on for all operations.
     * @link http://php.net/manual/zh/class.mongodb.php#mongodb.constants.profiling-on
	 */
     ...
     * Inherited by instances of {@link http://php.net/manual/zh/class.mongocollection.php MongoCollection} derived
     ...
     * ( {@link http://php.net/manual/zh/mongocollection.insert.php MongoCollection::insert()},
     * {@link http://php.net/manual/zh/mongocollection.update.php MongoCollection::update()},
     * {@link http://php.net/manual/zh/mongocollection.remove.php MongoCollection::remove()},
     * {@link http://php.net/manual/zh/mongocollection.save.php MongoCollection::save()}, and
     * {@link http://php.net/manual/zh/mongocollection.ensureindex.php MongoCollection::ensureIndex()} all support this
     ...
     * {@link http://php.net/manual/zh/class.mongocursorexception.php MongoCursorException}. It is tempting to set
    ...
    */
     ...
     * @link http://php.net/manual/zh/mongodb.setslaveokay.php
    ...
    */
     ...
     * @link http://php.net/manual/zh/mongodb.getwriteconcern.php
     * @return array <p>This function returns an array describing the write concern.
     * The array contains the values w for an integer acknowledgement level or string mode,
     * and wtimeout denoting the maximum number of milliseconds to wait for the server to satisfy the write concern.</p>
     */
    ...
    */
    ...
    /**
     * (PECL mongo &gt;= 1.5.0)<br/>
     * @link http://php.net/manual/zh/mongodb.setwriteconcern.php
...
class MongoCollection {
     /**
     * @link http://php.net/manual/zh/class.mongocollection.php#mongocollection.constants.ascending
     */
    const ASCENDING = 1;

     /**
     * @link http://php.net/manual/zh/class.mongocollection.php#mongocollection.constants.descending
     */
    const DESCENDING = -1;
    ...
    */
     ...
     * {@link http://php.net/manual/zh/mongocollection.aggregate.php MongoCollection::aggregate()}.
     * This method returns a {@link http://php.net/manual/zh/class.mongocommandcursor.php MongoCommandCursor} object.
     * This cursor object implements the {@link http://php.net/manual/zh/class.iterator.php Iterator} interface
     * just like the {@link http://php.net/manual/zh/class.mongocursor.php MongoCursor} objects that are returned
     * by the {@link http://php.net/manual/zh/mongocollection.find.php MongoCollection::find()} method
     * </p>
     *
     * @link http://php.net/manual/zh/mongocollection.aggregatecursor.php
     *
     ...
     *
     * @return MongoCommandCursor Returns a {@link http://php.net/manual/zh/class.mongocommandcursor.php MongoCommandCursor} object
     */
...
class MongoCursor implements Iterator, Traversable {
    /**
     * @link http://php.net/manual/zh/class.mongocursor.php#mongocursor.props.slaveokay
	 * @static
     * @var bool $slaveOkay
     */
     ...
     * {link http://php.net/manual/zh/mongocursor.timeout.php MongoCursor::timeout()}. This does not cause the
     * MongoDB server to cancel the operation; it only instructs the driver to
     * stop waiting for a response and throw a
     * {@link http://php.net/manual/zh/class.mongocursortimeoutexception.php MongoCursorTimeoutException} after a set time.
     * </p>
     */
    ...
    */
	 ...
	 * @link http://php.net/manual/zh/mongocursor.maxtimems.php
	 * @param int $ms <p>
...
class MongoGridFS extends MongoCollection {
    ...
    /**
     * @link http://php.net/manual/zh/class.mongogridfs.php#mongogridfs.props.chunks
     * @var $chunks MongoCollection
     */
    public $chunks;

    /**
     * @link http://php.net/manual/zh/class.mongogridfs.php#mongogridfs.props.filesname
     * @var $filesName string
     */
    protected $filesName;

    /**
     * @link http://php.net/manual/zh/class.mongogridfs.php#mongogridfs.props.chunksname
     ...
     *
     * @link http://php.net/manual/zh/mongogridfs.construct.php
     ...
     * @link http://php.net/manual/zh/mongogridfs.drop.php
     * @return array The database response
     */
    public function drop() {}

    /**
     * @link http://php.net/manual/zh/mongogridfs.find.php
     ...
     * @link http://php.net/manual/zh/mongogridfs.storefile.php
     ...
     * @link http://php.net/manual/zh/mongogridfs.storebytes.php
     ...
     * @link http://php.net/manual/zh/mongogridfs.delete.php
    ...
    */
    public function __get($id) {}
     ...
     /**
     * Stores a file in the database
     * @link http://php.net/manual/zh/mongogridfs.put.php
     * @param string $filename The name of the file
     * @param array $extra Other metadata to add to the file saved
     * @return mixed Returns the _id of the saved object
     */
...
class MongoGridFSFile {
    /**
    * @link http://php.net/manual/zh/class.mongogridfsfile.php#mongogridfsfile.props.file
    * @var $file
    */
    public $file;

    /**
    * @link http://php.net/manual/zh/class.mongogridfsfile.php#mongogridfsfile.props.gridfs
    * @var $gridfs
    */
    protected $gridfs;

    /**
     * @link http://php.net/manual/zh/mongogridfsfile.construct.php
     ...
     * @link http://php.net/manual/zh/mongogridfsfile.getfilename.php
    ...
    */
     ...
     * @link http://php.net/manual/zh/mongogridfsfile.getsize.php
    ...
    */
     ...
     * @link http://php.net/manual/zh/mongogridfsfile.write.php
     ...
     * @link http://php.net/manual/zh/mongogridfsfile.getbytes.php
     ...
     *
     * @link http://php.net/manual/zh/mongogridfsfile.getresource.php
...
class MongoGridFSCursor extends MongoCursor implements Traversable, Iterator {
    ...
    */
    ...
    /**
    * @link http://php.net/manual/zh/class.mongogridfscursor.php#mongogridfscursor.props.gridfs
    * @var $gridfs
    */
    protected $gridfs;
    ...
    /**
     * Create a new cursor
     * @link http://php.net/manual/zh/mongogridfscursor.construct.php
    ...
    * @link http://php.net/manual/zh/mongogridfscursor.getnext.php
    ...
    * @link http://php.net/manual/zh/mongogridfscursor.current.php
    ...
    * @link http://php.net/manual/zh/mongogridfscursor.key.php
...
class MongoId {
     ...
     * {@link http://php.net/manual/zh/language.types.string.php#language.types.string.parsing.complex complex variable parsed syntax} (e.g. $mongoId->{'$id'}).</p>
     */
     public $id = NULL;
     ...
     * @link http://php.net/manual/zh/mongoid.isvalid.php
    ...
    */
     ...
     * @link http://php.net/manual/zh/mongoid.getinc.php
     ...
     * (PECL mongo &gt;= 1.0.11)
     * Gets the process ID
     * @link http://php.net/manual/zh/mongoid.getpid.php
    ...
    */
     ...
     * @link http://php.net/manual/zh/mongoid.set-state.php
...
class MongoCode {
    ...
    */
     ...
     * .
     *
     * @link http://php.net/manual/zh/mongocode.construct.php
...
class MongoRegex {
    /**
     * @link http://php.net/manual/zh/class.mongoregex.php#mongoregex.props.regex
     * @var $regex
     */
    public $regex;

    /**
     * @link http://php.net/manual/zh/class.mongoregex.php#mongoregex.props.flags
     * @var $flags
     */
    public $flags;
     ...
     *
     * @link http://php.net/manual/zh/mongoregex.construct.php
...
class MongoDate {
    /**
     * @link http://php.net/manual/zh/class.mongodate.php#mongodate.props.sec
     * @var int $sec
     */
    public $sec;

    /**
     * @link http://php.net/manual/zh/class.mongodate.php#mongodate.props.usec
     * @var int $usec
     */
    public $usec;
     ...
     *
     * @link http://php.net/manual/zh/mongodate.construct.php
     ...
     * @link http://php.net/manual/zh/mongodate.todatetime.php
     * @return DateTime
     */
...
class MongoBinData {
	/**
	 * Generic binary data.
	 * @link http://php.net/manual/zh/class.mongobindata.php#mongobindata.constants.custom
	 */
	const GENERIC = 0x0;

     /**
	  * Function
     * @link http://php.net/manual/zh/class.mongobindata.php#mongobindata.constants.func
     */
    const FUNC = 0x1;

     /**
	  * Generic binary data (deprecated in favor of MongoBinData::GENERIC)
     * @link http://php.net/manual/zh/class.mongobindata.php#mongobindata.constants.byte-array
     */
    const BYTE_ARRAY = 0x2;

     /**
	  * Universally unique identifier (deprecated in favor of MongoBinData::UUID_RFC4122)
     * @link http://php.net/manual/zh/class.mongobindata.php#mongobindata.constants.uuid
     */
    const UUID = 0x3;
	...
	/**
	 * MD5
     * @link http://php.net/manual/zh/class.mongobindata.php#mongobindata.constants.md5
     */
    const MD5 = 0x5;
    ...
    /**
     * @link http://php.net/manual/zh/class.mongobindata.php#mongobindata.props.bin
     * @var $bin
     */
    public $bin;

    /**
     * @link http://php.net/manual/zh/class.mongobindata.php#mongobindata.props.type
     * @var $type
     */
    public $type;
     ...
     *
     * @link http://php.net/manual/zh/mongobindata.construct.php
...
class MongoDBRef {
    ...
    */
     ...
     *
     * @link http://php.net/manual/zh/mongodbref.create.php
     * @static
     ...
     *
     * @link http://php.net/manual/zh/mongodbref.isref.php
     * @static
     ...
     * @link http://php.net/manual/zh/mongodbref.get.php
     * @static
...
class MongoWriteBatch
{
	 ...
	 * @link http://php.net/manual/zh/mongowritebatch.construct.php
	 * @param MongoCollection $collection The {@see MongoCollection} to execute the batch on.
	 * Its {@link http://php.net/manual/zh/mongo.writeconcerns.php write concern}
	 ...
	 * </thead>
	 * <tbody><tr><td>w (int|string)</td><td>{@link http://php.net/manual/zh/mongo.writeconcerns.php Write concern} value</td></tr>
	 * <tr><td>wtimeout (int)</td><td>{@link http://php.net/manual/zh/mongo.writeconcerns.php Maximum time to wait for replication}</td></tr>
	 ...
	 * @link http://php.net/manual/zh/mongowritebatch.add.php
	 * @param array $item <p>
	 ...
	 * @link http://php.net/manual/zh/mongowritebatch.execute.php
...
class MongoUpdateBatch extends MongoWriteBatch
{
	 ...
	 * @link http://php.net/manual/zh/mongoupdatebatch.construct.php
	 ...
	 * </thead>
	 * <tbody class="tbody"><tr><td>w (int|string)</td><td>{@link http://php.net/manual/zh/mongo.writeconcerns.php Write concern} value</td></tr>
	 * <tr><td>wtimeout (int)</td><td>{@link http://php.net/manual/zh/mongo.writeconcerns.php Maximum time to wait for replication}</td></tr>
...
/**
 * <p>(PECL mongo &gt;= 1.5.0)</p>
 * @link http://php.net/manual/zh/class.mongowriteconcernexception.php#class.mongowriteconcernexception
 */
class MongoWriteConcernException extends MongoCursorException {
    /**
     * Get the error document
     * @link http://php.net/manual/zh/mongowriteconcernexception.getdocument.php
...
/**
 * <p>(PECL mongo &gt;= 1.5.0)</p>
 * @link http://php.net/manual/zh/class.mongoexecutiontimeoutexception.php
 */
...
/**
 * <p>(PECL mongo &gt;= 1.5.0)</p>
 * @link http://php.net/manual/zh/class.mongoduplicatekeyexception.php
 */
 ...
 * @link http://php.net/manual/zh/class.mongoresultexception.php#mongoresultexception.props.document
 *
 */
class MongoResultException extends MongoException {
     ...
     * http://php.net/manual/zh/mongoresultexception.getdocument.php
...
class MongoTimestamp {
    /**
     * @link http://php.net/manual/zh/class.mongotimestamp.php#mongotimestamp.props.sec
     * @var $sec
     */
    public $sec;

    /**
     * @link http://php.net/manual/zh/class.mongotimestamp.php#mongotimestamp.props.inc
     * @var $inc
     */
    public $inc;
 ...
 /**
     ...
     *
     * @link http://php.net/manual/zh/mongotimestamp.construct.php
...
class MongoInt32 {
    /**
     * @link http://php.net/manual/zh/class.mongoint32.php#mongoint32.props.value
     * @var $value
     */
    public $value;
     ...
     *
     * @link http://php.net/manual/zh/mongoint32.construct.php
...
class MongoInt64 {
    /**
     * @link http://php.net/manual/zh/class.mongoint64.php#mongoint64.props.value
     * @var $value
     */
    public $value;
     ...
     *
     * @link http://php.net/manual/zh/mongoint64.construct.php
     * @param string $value A number
     */
    public function __construct($value) {}
...
class MongoLog {
        /**
     * @link http://php.net/manual/zh/class.mongolog.php#mongolog.constants.none
     */
    const NONE = 0;

        /**
     * @link http://php.net/manual/zh/class.mongolog.php#mongolog.constants.all
     */
    const ALL = 0;

        /**
     * @link http://php.net/manual/zh/class.mongolog.php#mongolog.constants.warning
     */
    const WARNING = 0;

        /**
     * @link http://php.net/manual/zh/class.mongolog.php#mongolog.constants.info
     */
    const INFO = 0;

        /**
     * @link http://php.net/manual/zh/class.mongolog.php#mongolog.constants.fine
     */
    const FINE = 0;

        /**
     * @link http://php.net/manual/zh/class.mongolog.php#mongolog.constants.rs
     */
    const RS = 0;

        /**
     * @link http://php.net/manual/zh/class.mongolog.php#mongolog.constants.pool
     */
    const POOL = 0;

        /**
     * @link http://php.net/manual/zh/class.mongolog.php#mongolog.constants.io
     */
    const IO = 0;

        /**
     * @link http://php.net/manual/zh/class.mongolog.php#mongolog.constants.server
     */
    const SERVER = 0;

        /**
     * @link http://php.net/manual/zh/class.mongolog.php#mongolog.constants.parse
     */
    const PARSE = 0;
     ...
     *
     * @link http://php.net/manual/zh/mongolog.setlevel.php
     * @static
     ...
     *
     * @link http://php.net/manual/zh/mongolog.getlevel.php
     * @static
     ...
     *
     * @link http://php.net/manual/zh/mongolog.setmodule.php
     * @static
     ...
     *
     * @link http://php.net/manual/zh/mongolog.getmodule.php
     * @static
...
class MongoPool {
     ...
     *
     * @link http://php.net/manual/zh/mongopool.info.php
     * @static
     ...
     *
     * @link http://php.net/manual/zh/mongopool.setsize.php
     * @static
     ...
     * .
     *
     * @link http://php.net/manual/zh/mongopool.getsize.php
     * @static
     * @return int Returns the current pool size
     */
