...
class finfo  {
	 ...
	 * @link http://php.net/manual/zh/function.finfo-set-flags.php
	 * @param int $options <p>
	 ...
	 * @link http://php.net/manual/zh/function.finfo-file.php
	 ...
	 * @link http://php.net/manual/zh/function.finfo-buffer.php
 ...
 * @link http://php.net/manual/zh/function.finfo-open.php
 * @param int $options [optional] <p>
 * One or disjunction of more Fileinfo
 * constants.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.finfo-close.php
 ...
 * @link http://php.net/manual/zh/function.mime-content-type.php
...
/**
 * No special handling.
 * @link http://php.net/manual/zh/fileinfo.constants.php
 */
