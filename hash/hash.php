 ...
 * @link http://php.net/manual/zh/function.hash.php
 * @param string $algo <p>
 ...
 * @link http://php.net/manual/zh/function.hash-equals.php
 ...
 * @link http://php.net/manual/zh/function.hash-file.php
 * @param string $algo <p>
 * Name of selected hashing algorithm (i.e. "md5", "sha256", "haval160,4", etc..)
 * </p>
 ...
 * @link http://php.net/manual/zh/function.hash-hmac.php
 * @param string $algo <p>
 ...
 * @link http://php.net/manual/zh/function.hash-hmac-file.php
 * @param string $algo <p>
 * Name of selected hashing algorithm (i.e. "md5", "sha256", "haval160,4", etc..) See <b>hash_algos</b> for a list of supported algorithms.
 * </p>
 * @param string $filename <p>
 ...
 * @link http://php.net/manual/zh/function.hash-init.php
 * @param string $algo <p>
 ...
 * @link http://php.net/manual/zh/function.hash-update.php
 ...
 * @link http://php.net/manual/zh/function.hash-update-stream.php
 * @param resource $context <p>
 * Hashing context returned by <b>hash_init</b>.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.hash-update-file.php
 ...
 * @link http://php.net/manual/zh/function.hash-final.php
 * @param resource $context <p>
 * Hashing context returned by <b>hash_init</b>.
 * </p>
 * @param bool $raw_output [optional] <p>
 ...
 * @link http://php.net/manual/zh/function.hash-copy.php
 * @param resource $context <p>
 * Hashing context returned by <b>hash_init</b>.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.hash-algos.php
 ...
 * @link http://php.net/manual/zh/function.hash-pbkdf2.php
 * @param $algo
 * @param $password
 * @param $salt
 * @param $iterations
...
/**
 * Generates a key
 * @link http://php.net/manual/zh/function.mhash-keygen-s2k.php
 * @param int $hash <p>
 ...
 * @link http://php.net/manual/zh/function.mhash-get-block-size.php
 * @param int $hash <p>
 ...
 * @link http://php.net/manual/zh/function.mhash-get-hash-name.php
 * @param int $hash <p>
 * The hash ID. One of the <b>MHASH_hashname</b> constants.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.mhash-count.php
...
/**
 * Computes hash
 * @link http://php.net/manual/zh/function.mhash.php
 * @param int $hash <p>
 * The hash ID. One of the <b>MHASH_hashname</b> constants.
 * </p>
 * @param string $data <p>
 ...
 * @link http://php.net/manual/zh/hash.constants.php
 */
define ('HASH_HMAC', 1);
