 ...
 * @link http://php.net/manual/zh/class.memcached.php
 */
class Memcached  {
	 ...
	 * @link http://php.net/manual/zh/memcached.construct.php
	 ...
	 * @link http://php.net/manual/zh/memcached.getresultcode.php
	 ...
	 * @link http://php.net/manual/zh/memcached.getresultmessage.php
	 ...
	 * (PECL memcached &gt;= 0.1.0)<br/>
	 * Retrieve an item
	 * @link http://php.net/manual/zh/memcached.get.php
	 * @param string $key <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.getbykey.php
	 ...
	 * @link http://php.net/manual/zh/memcached.getmulti.php
	 * @param array $keys <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.getmultibykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param array $keys <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.getdelayed.php
	 * @param array $keys <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.getdelayedbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param array $keys <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.fetch.php
	 ...
	 * @link http://php.net/manual/zh/memcached.fetchall.php
	 ...
	 * (PECL memcached &gt;= 0.1.0)<br/>
	 * Store an item
	 * @link http://php.net/manual/zh/memcached.set.php
	 * @param string $key <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.setbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.touch.php
	 * @param string $key <p>
	 * The key under which to store the value.
	 * </p>
	 ...
	 * @link http://php.net/manual/zh/memcached.touchbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.setmulti.php
	 * @param array $items <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.setmultibykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param array $items <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.cas.php
	 ...
	 * @link http://php.net/manual/zh/memcached.casbykey.php
	 * @param float $cas_token <p>
	 * Unique value associated with the existing item. Generated by memcache.
	 * </p>
	 * @param string $server_key <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.add.php
	 * @param string $key <p>
	 * The key under which to store the value.
	 * </p>
	 * @param mixed $value <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.addbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.append.php
	 * @param string $key <p>
	 * The key under which to store the value.
	 * </p>
	 ...
	 * @link http://php.net/manual/zh/memcached.appendbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.prepend.php
	 * @param string $key <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.prependbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.replace.php
	 * @param string $key <p>
	 * The key under which to store the value.
	 * </p>
	 * @param mixed $value <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.replacebykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * (PECL memcached &gt;= 0.1.0)<br/>
	 * Delete an item
	 * @link http://php.net/manual/zh/memcached.delete.php
	 * @param string $key <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.deletemulti.php
	 * @param array $keys <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.deletebykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.deletemultibykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param array $keys <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.increment.php
	 * @param string $key <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.decrement.php
	 * @param string $key <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.incrementbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.decrementbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.addserver.php
	 * @param string $host <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.addservers.php
	 * @param array $servers
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 */
	 ...
	 * @link http://php.net/manual/zh/memcached.getserverlist.php
	 ...
	 * @link http://php.net/manual/zh/memcached.getserverbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 ...
	 * @link http://php.net/manual/zh/memcached.resetserverlist.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 */
	 ...
	 * @link http://php.net/manual/zh/memcached.quit.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 */
	 ...
	 * @link http://php.net/manual/zh/memcached.getstats.php
	 ...
	 * @link http://php.net/manual/zh/memcached.getversion.php
	 ...
	 * @link http://php.net/manual/zh/memcached.getallkeys.php
	 ...
	 * @link http://php.net/manual/zh/memcached.flush.php
	 ...
	 * @link http://php.net/manual/zh/memcached.getoption.php
	 * @param int $option <p>
	 ...
	 * @link http://php.net/manual/zh/memcached.setoption.php
	 * @param int $option
	 * @param mixed $value
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 */
	 ...
	 * @link http://php.net/manual/zh/memcached.ispersistent.php
	 ...
	 * @link http://php.net/manual/zh/memcached.ispristine.php
...
/**
 * @link http://php.net/manual/zh/class.memcachedexception.php
 */
