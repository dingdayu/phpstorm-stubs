 ...
 * @link http://php.net/manual/zh/function.spl-classes.php
 * @return array 
 * @since 5.0
 */
 ...
 * @link http://php.net/manual/zh/function.spl-autoload.php
 ...
 * @link http://php.net/manual/zh/function.spl-autoload-extensions.php
 * @param string $file_extensions [optional] <p>
 ...
 * @link http://php.net/manual/zh/function.spl-autoload-functions.php
 ...
 * @link http://php.net/manual/zh/function.spl-autoload-call.php
 * @param string $class_name <p>
 ...
 * @link http://php.net/manual/zh/function.class-parents.php
 * @param mixed $class <p>
 ...
 * @link http://php.net/manual/zh/function.class-implements.php
 * @param mixed $class <p>
 * An object (class instance) or a string (class name).
 * </p>
 * @param bool $autoload [optional] <p>
 ...
 * @link http://php.net/manual/zh/function.spl-object-hash.php
 * @param object $obj 
 ...
 * @link http://php.net/manual/zh/function.iterator-to-array.php
 ...
 * @link http://php.net/manual/zh/function.iterator-count.php
 * @param Traversable $iterator <p>
 ...
 * @link http://php.net/manual/zh/function.iterator-apply.php
 * @param Traversable $iterator <p>
 ...
 * @link http://php.net/manual/zh/function.class-uses.php
 * @see class_parents()
