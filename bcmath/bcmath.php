 ...
 * @link http://php.net/manual/zh/function.bcadd.php
 ...
 * @link http://php.net/manual/zh/function.bcsub.php
 * @param string $left_operand <p>
 * The left operand, as a string.
 * </p>
 * @param string $right_operand <p>
 ...
 * @link http://php.net/manual/zh/function.bcmul.php
 * @param string $left_operand <p>
 * The left operand, as a string.
 * </p>
 * @param string $right_operand <p>
 ...
 * @link http://php.net/manual/zh/function.bcdiv.php
 * @param string $left_operand <p>
 * The left operand, as a string.
 * </p>
 * @param string $right_operand <p>
 ...
 * @link http://php.net/manual/zh/function.bcmod.php
 * @param string $left_operand <p>
 * The left operand, as a string.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.bcpow.php
 * @param string $left_operand <p>
 * The left operand, as a string.
 * </p>
 * @param string $right_operand <p>
 ...
 * @link http://php.net/manual/zh/function.bcsqrt.php
 ...
 * @link http://php.net/manual/zh/function.bcscale.php
 * @param int $scale <p>
 * The scale factor.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.bccomp.php
 * @param string $left_operand <p>
 * The left operand, as a string.
 * </p>
 * @param string $right_operand <p>
 ...
 * @link http://php.net/manual/zh/function.bcpowmod.php
 * @param string $left_operand <p>
 * The left operand, as a string.
 * </p>
 * @param string $right_operand <p>
