...
/**
 * Frees a private key
 * @link http://php.net/manual/zh/function.openssl-pkey-free.php
 ...
 * @link http://php.net/manual/zh/function.openssl-pkey-new.php
 ...
 * @link http://php.net/manual/zh/function.openssl-pkey-export.php
 * @param mixed $key
 * @param string $out
 ...
 * @link http://php.net/manual/zh/function.openssl-pkey-export-to-file.php
 * @param mixed $key
...
/**
 * Get a private key
 * @link http://php.net/manual/zh/function.openssl-pkey-get-private.php
 * @param $key
 * <p>
 ...
 * @link http://php.net/manual/zh/function.openssl-pkey-get-details.php
 * @param resource $key <p>
 * Resource holding the key.
 * </p>
...
/**
 * Free key resource
 * @link http://php.net/manual/zh/function.openssl-free-key.php
 ...
 * @link http://php.net/manual/zh/function.openssl-get-privatekey.php
 * @param $key
 * <p>
 * <b><em>key</em></b> can be one of the following:
 * <ol>
 ...
 * @link http://php.net/manual/zh/function.openssl-get-publickey.php
 ...
 * @link http://php.net/manual/zh/function.openssl-spki-new.php
 ...
 * @link http://php.net/manual/zh/function.openssl-spki-verify.php
 ...
 * @link http://php.net/manual/zh/function.openssl-spki-export-challenge.php
 * @param string $spkac <p>Expects a valid signed public key and challenge</p>
 ...
 * @link http://php.net/manual/zh/function.openssl-spki-export.php
 * @param string $spkac <p>Expects a valid signed public key and challenge</p>
 ...
 * @since 5.0
it
 * @link http://php.net/manual/zh/function.openssl-x509-read.php
 ...
 * @link http://php.net/manual/zh/function.openssl-x509-free.php
 ...
 * @link http://php.net/manual/zh/function.openssl-x509-parse.php
 ...
 * @link http://php.net/manual/zh/function.openssl-x509-checkpurpose.php
 ...
 * @link http://php.net/manual/zh/function.openssl-x509-check-private-key.php
 * @param mixed $cert <p>
 * The certificate.
 * </p>
 * @param mixed $key <p>
 ...
 * @link http://php.net/manual/zh/function.openssl-x509-export.php
 * @param mixed $x509
 ...
 * @link http://php.net/manual/zh/function.openssl-x509-export-to-file.php
 * @param mixed $x509
 * @param string $outfilename <p>
 * Path to the output file.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.openssl-pkcs12-export.php
 * @param mixed $x509
 * @param string $out <p>
 ...
 * @link http://php.net/manual/zh/function.openssl-pkcs12-export-to-file.php
 * @param mixed $x509
 ...
 * @link http://php.net/manual/zh/function.openssl-pkcs12-read.php
 * @param string $pkcs12
 * @param array $certs <p>
...
/**
 * Generates a CSR
 * @link http://php.net/manual/zh/function.openssl-csr-new.php
 * @param array $dn <p>
 ...
 * @link http://php.net/manual/zh/function.openssl-csr-export.php
 * @param resource $csr
 * @param string $out
 * @param bool $notext [optional] &note.openssl.param-notext;
 * @return bool true on success or false on failure.
 ...
 * @link http://php.net/manual/zh/function.openssl-csr-export-to-file.php
 * @param resource $csr
 * @param string $outfilename <p>
 * Path to the output file.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.openssl-csr-sign.php
 * @param mixed $csr <p>
 ...
 * @link http://php.net/manual/zh/function.openssl-csr-get-subject.php
 * @param mixed $csr
 ...
 * @link http://php.net/manual/zh/function.openssl-csr-get-public-key.php
 * @param mixed $csr
 * @param bool $use_shortnames [optional]
 * @return resource
 * @since 5.2.0
...
/**
 * Computes a digest
 * @link http://php.net/manual/zh/function.openssl-digest.php
 * @param string $data <p>
 * The data.
 * </p>
...
/**
 * Encrypts data
 * @link http://php.net/manual/zh/function.openssl-encrypt.php
 * @param string $data <p>
 * The data.
 * </p>
 * @param string $method <p>
...
/**
 * Decrypts data
 * @link http://php.net/manual/zh/function.openssl-decrypt.php
 * @param string $data <p>
 * The data.
 * </p>
 * @param string $method <p>
 ...
 * @link http://php.net/manual/zh/function.openssl-cipher-iv-length.php
 * @param string $method <p>
 * The method.
 * </p>
...
/**
 * Generate signature
 * @link http://php.net/manual/zh/function.openssl-sign.php
 * @param string $data
...
/**
 * Verify signature
 * @link http://php.net/manual/zh/function.openssl-verify.php
 * @param string $data
...
/**
 * Seal (encrypt) data
 * @link http://php.net/manual/zh/function.openssl-seal.php
 * @param string $data
...
/**
 * Open sealed data
 * @link http://php.net/manual/zh/function.openssl-open.php
 * @param string $sealed_data
 ...
 * @link http://php.net/manual/zh/function.openssl-pkcs7-verify.php
 * @param string $filename <p>
 * Path to the message.
 * </p>
 * @param int $flags <p>
 ...
 * @link http://php.net/manual/zh/function.openssl-pkcs7-decrypt.php
 ...
 * @link http://php.net/manual/zh/function.openssl-pkcs7-sign.php
 * @param string $infilename
 ...
 * @link http://php.net/manual/zh/function.openssl-pkcs7-encrypt.php
 * @param string $infile
 ...
 * @link http://php.net/manual/zh/function.openssl-private-encrypt.php
 * @param string $data
 ...
 * @link http://php.net/manual/zh/function.openssl-private-decrypt.php
 * @param string $data
 ...
 * @link http://php.net/manual/zh/function.openssl-public-decrypt.php
 * @param string $data
 * @param string $decrypted
 * @param mixed $key <p>
 ...
 * @link http://php.net/manual/zh/function.openssl-dh-compute-key.php
 ...
 * @link http://php.net/manual/zh/function.openssl-error-string.php
 ...
 * @link http://php.net/manual/zh/function.openssl-get-cert-locations.php
 ...
 * <b>openssl_verify</b>.
 * @link http://php.net/manual/zh/openssl.constants.php
 */
...
/** @link http://php.net/manual/zh/openssl.ciphers.php */
