<?php
/**
 * @link http://php.net/manual/zh/gearman.constants.php
 */
...
class GearmanClient {
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.construct.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.returncode.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.error.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.geterrno.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.setoptions.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.addoptions.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.removeoptions.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.timeout.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.settimeout.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.context.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.setcontext.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.addserver.php
     * @param string $host
     * @param int $port
     * @return bool
     */
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.addservers.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.dohigh.php
     * @param string $function_name
     * @param string $workload
     * @param string $unique
     ...
     * priority tasks in the job queue.
     *
     * @link http://php.net/manual/zh/gearmanclient.dolow.php
     * @param string $function_name
     * @param string $workload
     * @param string $unique
     * @return string A string representing the results of running a task
     ...
     * the task.
     *
     * @link http://php.net/manual/zh/gearmanclient.dojobhandle.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.dostatus.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.dobackground.php
     * @param string $function_name
     * @param string $workload
     * @param string $unique
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.dohighbackground.php
     * @param string $function_name
     * @param string $workload
     * @param string $unique
     * @return string The job handle for the submitted task
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.dolowbackground.php
     * @param string $function_name
     * @param string $workload
     * @param string $unique
     * @return string The job handle for the submitted task
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.jobstatus.php
     ...
     * parallel.
     *
     * @link http://php.net/manual/zh/gearmanclient.addtask.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.addtaskhigh.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.addtasklow.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     * perform the work.
     *
     * @link http://php.net/manual/zh/gearmanclient.addtaskbackground.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     * selected from the queue before those of normal or low priority.
     *
     * @link http://php.net/manual/zh/gearmanclient.addtaskhighbackground.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.addtasklowbackground.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.addtaskstatus.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.setworkloadcallback.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.setcreatedcallback.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.setdatacallback.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.setwarningcallback.php
     * @param callback $callback A function to call
     * @return bool
     */
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.setstatuscallback.php
     * @param callback $callback A function to call
     * @return bool
     */
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.setcompletecallback.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.setexceptioncallback.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.setfailcallback.php
     * @param callback $callback A function to call
     * @return bool
     */
     ...
     *
     * @link http://php.net/manual/zh/gearmanclient.clearcallbacks.php
     * @return bool Always returns true
     */
     ...
     * parallel.
     *
     * @link http://php.net/manual/zh/gearmanclient.runtasks.php
     * @return bool
     */
...
class GearmanTask {
     ...
     *
     * @link http://php.net/manual/zh/gearmantask.returncode.php
     * @return int A valid Gearman return code
     */
    public function returnCode() {}
     ...
     *
     * @link http://php.net/manual/zh/gearmantask.functionname.php
     ...
     * server.
     *
     * @link http://php.net/manual/zh/gearmantask.unique.php
     ...
     *
     * @link http://php.net/manual/zh/gearmantask.jobhandle.php
     ...
     * server.
     *
     * @link http://php.net/manual/zh/gearmantask.isknown.php
     ...
     *
     * @link http://php.net/manual/zh/gearmantask.isrunning.php
     ...
     * as a fraction.
     *
     * @link http://php.net/manual/zh/gearmantask.tasknumerator.php
     ...
     * as a fraction.
     *
     * @link http://php.net/manual/zh/gearmantask.taskdenominator.php
     * @return int A number between 0 and 100, or false if cannot be determined
     */
     ...
     * .
     *
     * @link http://php.net/manual/zh/gearmantask.sendworkload.php
     ...
     *
     * @link http://php.net/manual/zh/gearmantask.data.php
     ...
     *
     * @link http://php.net/manual/zh/gearmantask.datasize.php
     ...
     * .
     *
     * @link http://php.net/manual/zh/gearmantask.recvdata.php
...
class GearmanWorker {
     ...
     *
     * @link http://php.net/manual/zh/gearmanworker.construct.php
     ...
     * Returns the last Gearman return code.
     *
     * @link http://php.net/manual/zh/gearmanworker.returncode.php
     * @return int A valid Gearman return code
     */
    public function returnCode() {}
     ...
     * Returns an error string for the last error encountered.
     *
     * @link http://php.net/manual/zh/gearmanworker.error.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanworker.geterrno.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanworker.options.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanworker.setoptions.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanworker.addoptions.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanworker.removeoptions.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanworker.timeout.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanworker.settimeout.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanworker.setid.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanworker.addserver.php
     * @param string $host
     * @param int $port
     * @return bool
     */
     ...
     *
     * @link http://php.net/manual/zh/gearmanworker.addservers.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanworker.wait.php
     * @return bool
     */
    public function wait() {}
     ...
     *
     * @link http://php.net/manual/zh/gearmanworker.register.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanworker.unregister.php
     * @param string $function_name The name of a function to register with the job
     *        server
     * @return bool A standard Gearman return value
     */
     ...
     * sent to this worker.
     *
     * @link http://php.net/manual/zh/gearmanworker.unregisterall.php
     * @return bool A standard Gearman return value
     */
     ...
     *
     * @link http://php.net/manual/zh/gearmanworker.addfunction.php
     * @param string $function_name The name of a function to register with the job
     *        server
     ...
     *
     * @link http://php.net/manual/zh/gearmanworker.work.php
     * @return bool
     */
...
class GearmanJob {
     ...
     *
     * @link http://php.net/manual/zh/gearmanjob.returncode.php
     * @return int A valid Gearman return code
     */
    public function returnCode() {}
     ...
     *
     * @link http://php.net/manual/zh/gearmanjob.setreturn.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanjob.senddata.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanjob.sendwarning.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanjob.sendstatus.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanjob.sendcomplete.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanjob.sendexception.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanjob.sendfail.php
     * @return bool
     */
     ...
     *
     * @link http://php.net/manual/zh/gearmanjob.handle.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanjob.functionname.php
     ...
     * client.
     *
     * @link http://php.net/manual/zh/gearmanjob.unique.php
     ...
     *
     * @link http://php.net/manual/zh/gearmanjob.workload.php
     ...
     * bytes.
     *
     * @link http://php.net/manual/zh/gearmanjob.workloadsize.php
...
class GearmanException extends Exception {
     ...
     * Prop description.
     *
     * @link http://php.net/manual/zh/class.gearmanexception.php#gearmanexception.props.code
     * @var $code
     */
    public $code;
