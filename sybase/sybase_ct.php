 ...
 * @link http://php.net/manual/zh/function.sybase-connect.php
 ...
 * @link http://php.net/manual/zh/function.sybase-pconnect.php
 * @param $servername string[optional]
 * @param $username string[optional]
 * @param $password string[optional]
 * @param $charset string[optional]
 ...
 * @link http://php.net/manual/zh/function.sybase-close.php
 ...
 * @link http://php.net/manual/zh/function.sybase-select-db.php
 ...
 * @link http://php.net/manual/zh/function.sybase-query.php
 * @param $query string
 * @param $link_identifier resource[optional]
 ...
 * @link http://php.net/manual/zh/function.sybase-unbuffered-query.php
 * @param $query string
...
/**
 * Frees result memory
 * @link http://php.net/manual/zh/function.sybase-free-result.php
 ...
 * @link http://php.net/manual/zh/function.sybase-get-last-message.php
 ...
 * @link http://php.net/manual/zh/function.sybase-num-rows.php
 * @param $result resource
 ...
 * @link http://php.net/manual/zh/function.sybase-num-fields.php
 * @param $result resource
 ...
 * @link http://php.net/manual/zh/function.sybase-fetch-row.php
 * @param $result resource
...
/**
 * Fetch row as array
 * @link http://php.net/manual/zh/function.sybase-fetch-array.php
 * @param $result resource
 * @return array an array that corresponds to the fetched row, or false if there
 */
 ...
 * @link http://php.net/manual/zh/function.sybase-fetch-assoc.php
 * @param $result resource
 * @return array an array that corresponds to the fetched row, or false if there
 */
 ...
 * @link http://php.net/manual/zh/function.sybase-fetch-object.php
 * @param $result resource
 ...
 * @link http://php.net/manual/zh/function.sybase-data-seek.php
 ...
 * @link http://php.net/manual/zh/function.sybase-fetch-field.php
 * @param $result resource
...
/**
 * Sets field offset
 * @link http://php.net/manual/zh/function.sybase-field-seek.php
 * @param $result resource
...
/**
 * Get result data
 * @link http://php.net/manual/zh/function.sybase-result.php
 * @param $result resource
 * @param $row int
 * @param $field mixed
 * @return string 
 ...
 * @link http://php.net/manual/zh/function.sybase-affected-rows.php
 * @param $link_identifier resource[optional]
 ...
 * @link http://php.net/manual/zh/function.sybase-min-client-severity.php
 * @param $severity int
 * @return void 
 */
 ...
 * @link http://php.net/manual/zh/function.sybase-min-server-severity.php
 * @param $severity int
 * @return void 
 */
 ...
 * @link http://php.net/manual/zh/function.sybase-set-message-handler.php
 ...
 * @link http://php.net/manual/zh/function.sybase-deadlock-retry-count.php
