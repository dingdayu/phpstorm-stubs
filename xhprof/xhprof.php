 ...
 *
 * @link http://php.net/manual/zh/function.xhprof-enable.php
 *
 * @param int   $flags   <p>Optional flags to add additional information to the profiling. See the a
 *                       href="http://php.net/manual/zh/xhprof.constants.php">XHprof constants</a> for further
 ...
 *
 * @link http://php.net/manual/zh/function.xhprof-disable.php
 ...
 *
 * @link http://php.net/manual/zh/function.xhprof-sample-enable.php
 * @return null
 */
 ...
 *
 * @link http://php.net/manual/zh/function.xhprof-sample-disable.php
...
/**
 * @type int
 * @link http://php.net/manual/zh/xhprof.constants.php#constant.xhprof-flags-no-builtins
 */
const XHPROF_FLAGS_NO_BUILTINS = 1;
/**
 * @type int
 * @link http://php.net/manual/zh/xhprof.constants.php#constant.xhprof-flags-cpu
 */
const XHPROF_FLAGS_CPU = 2;
/**
 * @type int
 * @link http://php.net/manual/zh/xhprof.constants.php##constant.xhprof-flags-memory
 */
